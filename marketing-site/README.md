...
from `origin/main` commit `90db2e33` with the rendered-accessibility runner at a 1024 by 768
CSS-pixel viewport. They show the real Waves host and repository-owned deterministic example
content, then were converted to WebP at quality 88 for the public site.
