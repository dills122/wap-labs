...
const strictWcmpFixtureEvidence = {
  ...
  command: 'cargo test --manifest-path transport-rust/Cargo.toml --test wcmp_cdpd_icmp_profile'
};
...
const generalWcmpClauseDefinitions = [
  [
    ...
    'Use the general WCMP protocol only for an explicitly selected non-IP bearer capability.'
  ],
  [
    'error_response_suppression',
    ['WCMP-SP-C-002'],
    '5.1',
    'explicit-must',
    'error-policy',
    'generation_suppresses_prohibited_error_responses',
    'Do not generate a WCMP error message in response to another WCMP error message.'
  ],
  [
    'fragment_error_single_response',
    ['WCMP-SP-C-002'],
    '5.1',
    'explicit-must',
    'error-policy',
  ...
  [
    'single_bearer_fragment',
    ['WCMP-SP-C-002'],
    '5.1',
    'explicit-must',
    'transport-boundary',
    'constrained_fragment_and_address_limits_reject_without_truncation',
    'Require each WCMP message to fit within one bearer-level fragment.'
  ],
  [
    'minimum_client_message_set',
    ['WCMP-SP-C-002', 'WCMP-GEN-C-001', 'WCMP-GEN-C-003', 'WCMP-GEN-C-006'],
    '5.2',
    'table',
    'transport-boundary',
    'source_derived_fixture_covers_non_ip_general_wcmp_capability_rows',
  ...
  [
    'ip_address_bit_order',
    ['WCMP-SP-C-002'],
    '5.5.2',
    'grammar',
    'binary-decoder',
    'selected_messages_preserve_exact_wap_1_2_1_bytes_and_roundtrip',
    'Encode an IP address within WCMP address data with the most significant bit first.'
  ],
  [
    'destination_unreachable_structure',
    ['WCMP-GEN-C-001'],
    '5.5.3.1',
    'grammar',
    'binary-decoder',
    'selected_messages_preserve_exact_wap_1_2_1_bytes_and_roundtrip',
    'Encode Destination Unreachable with Type, Code, destination and originator ports, address information, and no additional data.'
  ],
  [
    'destination_unreachable_generation',
    ['WCMP-GEN-C-001'],
    '5.5.3.1',
    'explicit-should',
    'error-policy',
    'generation_maps_remaining_destination_unreachable_failures',
    'Generate Destination Unreachable when a datagram cannot be delivered unless the failure is congestion.'
  ],
  [
    'port_unreachable_generation',
    ['WCMP-GEN-C-001'],
    '5.5.3.1',
    'explicit-must',
    'error-policy',
  ...
  [
    'destination_unreachable_codes',
    ['WCMP-GEN-C-001'],
    '5.5.3.1',
    'table',
    'error-policy',
    'reported_destination_unreachable_maps_remaining_codes_to_wdp_errors',
    'Interpret Destination Unreachable codes 0, 1, 3, and 4 with their specified route, policy, address, and port meanings.'
  ],
  [
    'destination_unreachable_address',
    ['WCMP-GEN-C-001'],
    '5.5.3.1',
    'grammar',
    'binary-decoder',
  ...
  [
    'message_too_big_type_code',
    ['WCMP-GEN-C-003'],
    '5.5.3.3',
    'table',
    'binary-decoder',
    'selected_messages_preserve_exact_wap_1_2_1_bytes_and_roundtrip',
    'Use Type 60 and Code 0 for a general-WCMP Message Too Big message.'
  ],
  [
    'message_too_big_destination_address',
    ['WCMP-GEN-C-003'],
    '5.5.3.3',
    'grammar',
    'binary-decoder',
  ...
  [
    ...
    'binary-decoder',
    'selected_messages_preserve_exact_wap_1_2_1_bytes_and_roundtrip',
    'Encode Echo messages with Type, Code, Identifier, Sequence Number, and optional data.'
  ],
  [
    'echo_reply_required',
    ['WCMP-GEN-C-006'],
    ...
    'Send an Echo Reply after receiving an Echo Request when the explicit non-IP capability permits replies.'
  ],
  [
    'echo_data_roundtrip',
    ['WCMP-GEN-C-006'],
    ...
    'transport-boundary',
    'echo_request_generates_exact_reply_and_preserves_correlation',
    'Return the Echo Request data unchanged in the corresponding Echo Reply when the return path can carry it.'
  ],
  [
    'echo_path_mtu_truncation',
    ['WCMP-GEN-C-006'],
    '5.5.3.5',
    'explicit-may',
    'transport-boundary',
    'echo_reply_truncates_only_data_to_return_path_fragment_size',
    'Truncate only Echo Reply data when the return-path bearer fragment size cannot carry the complete request data.'
  ],
  [
    'echo_type_code',
    ['WCMP-GEN-C-006'],
    ...
    'binary-decoder',
    'selected_messages_preserve_exact_wap_1_2_1_bytes_and_roundtrip',
    'Use Type 178 Code 0 for Echo Request and Type 179 Code 0 for Echo Reply.'
  ],
  [
    'echo_correlation_fields',
    ['WCMP-GEN-C-006'],
    '5.5.3.5',
    'grammar',
    'transport-boundary',
...
].map(([key, parentRows, section, normativeForce, fixtureKind, test, obligationSynopsis]) => ({
  key,
  parentRows,
  section,
  sourceAnchor: generalWcmpSourceAnchors[section],
  normativeForce,
  fixtureKind,
  test,
  obligationSynopsis
...
const implementedWml202ClauseIds = new Set(directWorkItemClauseIds.get('WML-202'));
const implementedWml203ClauseIds = new Set(directWorkItemClauseIds.get('WML-203'));
const implementedWml204ClauseIds = new Set(directWorkItemClauseIds.get('WML-204'));
...
const implementedWsp802ClauseIds = new Set([
  ...
  'WSP-CL-POST-CONTENT-TYPE',
  'WSP-CL-REPLY-CONTENT-TYPE',
  'WSP-CL-HEADER-HTTP-COMPATIBILITY',
  'WSP-CL-HEADER-COMPACTION-FORMS',
  'WSP-CL-HEADER-NAME-VERSION-CHOICE',
  'WSP-CL-HEADER-DEFAULT-PAGE',
  'WSP-CL-HEADER-CODE-PAGE-RANGES',
  'WSP-CL-HEADER-EXTENSION-PAGE-AGREEMENT',
  'WSP-CL-HEADER-VALUE-ENCODING-CHOICE',
  'WSP-CL-HEADER-VALUE-LENGTH-PREFIX',
  'WSP-CL-HEADER-UNKNOWN-VALUE-SKIP',
  'WSP-CL-HEADER-LIST-EXPANSION',
  'WSP-CL-HEADER-SYNTAX-REGISTRY',
  'WSP-CL-HEADER-FIELD-ASSIGNMENTS',
  'WSP-CL-EXPECT-SIN-ENCODING',
  'WSP-CL-ENCODING-VERSION-REQUIRED',
  'WSP-CL-ENCODING-VERSION-ABSENT-DEFAULT',
  'WSP-CL-ENCODING-VERSION-CLIENT-SELECTION',
  'WSP-CL-ENCODING-VERSION-NO-OVERCLAIM',
  'WSP-CL-ENCODING-VERSION-EXTENSION-PAGES',
  'WSP-CL-ENCODING-VERSION-PEER-CACHE',
  'WSP-CL-UNSUPPORTED-ENCODING-RETRY',
  'WSP-CL-ENCODING-VERSION-TEXT-FORM',
  'WSP-CL-ENCODING-VERSION-HOP-BY-HOP'
]);
const implementedWml305ClauseIds = new Set(directWorkItemClauseIds.get('WML-305'));
const implementedWml306NewClauseIds = new Set(['WML-CL-DECK-ACCESS-REQUIRED']);
const implementedWmls501ClauseIds = new Set(directWorkItemClauseIds.get('WMLS-501'));
...
const wmls502FixtureEvidence = {
  path: 'engine-wasm/engine/tests/fixtures/wmlscript/wap-193-operator-conversions.wmlsc.hex',
  testPath: 'engine-wasm/engine/src/wavescript/wap_runtime.rs',
  command:
...
const wml204FixtureTests = new Map([
  ...
  [
    'WML-CL-SELECT-STRUCTURE',
    'wml_fx_select_structure_flattens_nested_optgroups_in_document_order'
  ],
  [
    'WML-CL-SELECT-USER-UPDATE',
...
function wml301FixtureEvidence(clauseId) {
  ...
  if (
    ['WML-CL-EXTERNAL-NAVIGATION-NEW-CONTEXT', 'WML-CL-EXTERNAL-NAVIGATION-OLD-CONTEXT'].includes(
      clauseId
    )
  ) {
    return {
...
const wsp801FixtureEvidence = {
  ...
  command: 'cargo test --manifest-path transport-rust/Cargo.toml --test wsp_connectionless_matrix'
};
const wsp802FixtureEvidence = {
  path: 'transport-rust/tests/fixtures/transport/wsp_header_grammar_mapped/header_fixture.json',
  testPath: 'transport-rust/tests/wsp_header_grammar.rs',
  command: 'cargo test --manifest-path transport-rust/Cargo.toml --test wsp_header_grammar'
};
const wml305FixtureTests = new Map([
  [
    'WML-CL-GO-TIMER-THEN-DISPLAY',
    'wml_305_go_starts_destination_timer_before_host_render_boundary'
  ],
  ...
  [
    'WML-CL-TIMER-INITIAL-VALUE-PRECEDENCE',
    'wml_305_named_timer_uses_existing_variable_then_falls_back_to_value'
  ],
...
function refreshStrictWcmpFamily(manifest) {
  ...
  const selectedParents = parentLedger.obligations.filter(
    (obligation) =>
      obligation.disposition?.classCProfile === 'required-by-selected-class-c-transport-path'
  );
  ...
  const rfc792Artifact = rfc792?.artifacts.find((artifact) => artifact.id === 'rfc-792-text');
  ...
  const clauses = strictWcmpClauseDefinitions.map((definition) => {
    ...
    return {
      ...
      mapping: {
        ...
        workItems: [
          ...new Set([...parents.flatMap((parent) => parent.mapping.workItems), ...directWorkItems])
        ].sort(),
        requirementIds: [
        ...
        clauseImplementationStatus: strictWcmpImplemented ? 'implemented' : 'not-assessed',
        evidenceGate:
  ...
  const capabilityClauses = generalWcmpClauseDefinitions.map((definition) => {
    ...
    const directWorkItems = directWorkItemsForClause(id);
    const integrationProfileTest =
      definition.test === 'general_wcmp_is_available_only_with_the_explicit_non_ip_profile';
...
const wml306OptionalClauseDefinitions = [
  {
    key: 'low_memory_history_lru',
    section: '12.2.1',
    heading: '12.2.1 Limited History',
    normalizedTextSha256: '7c8fa322a4b4058ae8677683a417e3b43d595240b3ef004d63e80d9459ec2189',
    fixtureKind: 'state-machine',
    obligationSynopsis:
      'When a configured history limit is exhausted, delete the least-recently-used history information first.'
  },
  {
    key: 'low_memory_history_minimum',
    section: '12.2.1',
    heading: '12.2.1 Limited History',
    normalizedTextSha256: '7c8fa322a4b4058ae8677683a417e3b43d595240b3ef004d63e80d9459ec2189',
    fixtureKind: 'state-machine',
  ...
  {
    key: 'low_memory_context_reclaim',
    section: '12.2.2',
  ...
  {
    key: 'low_memory_context_failure_reset',
    section: '12.2.2',
    heading: '12.2.2 Limited Browser Context Size',
    normalizedTextSha256: '56b4cd8a388c0ac36a6379f3a9eeb0ee4f34e1c40e98718d1bcff7d2a9d66a0a',
    fixtureKind: 'error-policy',
...
function refreshWml306OptionalCapability(wmlFamily, parentLedger) {
  const sourceParent = parentLedger.obligations.find((candidate) => candidate.id === 'WML-C-15');
  if (!sourceParent) {
    throw new Error('wml/WML-C-15: optional low-memory parent is missing');
  }
  const directWorkItems = ['WML-306'];
  const capabilityClauses = wml306OptionalClauseDefinitions.map((definition) => {
    const id = `WML-CL-${definition.key.toUpperCase().replaceAll('_', '-')}`;
    return {
      id,
      family: 'wml',
      ...
      sourceAnchor: {
        ...
        normalizedTextSha256: definition.normalizedTextSha256
      },
      normativeForce: 'explicit-should',
      obligationLevel: 'recommended',
      obligationSynopsis: definition.obligationSynopsis,
      fixturePlan: {
        id: `WML-FX-${definition.key.toUpperCase().replaceAll('_', '-')}`,
        kind: definition.fixtureKind,
        status: 'implemented',
        assertion: definition.obligationSynopsis,
        evidence: definition.key.startsWith('low_memory_history_')
          ? {
              path: 'browser/frontend/src/session-history.test.ts',
              testPath: 'browser/frontend/src/session-history.test.ts',
              command: 'pnpm --dir browser/frontend test -- src/session-history.test.ts'
          ...
          : {
              path: 'engine-wasm/engine/tests/fixtures/wml-306/low-memory.wml',
      ...
      mapping: {
        ownerLayers: sourceParent.mapping.ownerLayers,
        workItems: [...new Set([...sourceParent.mapping.workItems, ...directWorkItems])].sort(),
        requirementIds: sourceParent.mapping.requirementIds,
        parentImplementationSnapshot: {
          'WML-C-15': sourceParent.mapping.implementationStatus
        },
        clauseImplementationStatus: 'implemented',
        evidenceGate:
          'Implemented optional Class C capability backed by source-derived WML-306 fixtures and direct engine/browser tests.'
      }
    };
  });
  wmlFamily.capabilityDisposition = 'optional-class-c-client-capability';
  wmlFamily.capabilityParentCount = 1;
  wmlFamily.capabilityClauseCount = capabilityClauses.length;
  wmlFamily.capabilityParents = [
    {
      id: sourceParent.id,
      feature: sourceParent.feature,
      referencedSection: sourceParent.referencedSection,
      sourceAnchor: sourceParent.sourceAnchor,
      implementationStatus: sourceParent.mapping.implementationStatus,
      ownerLayers: sourceParent.mapping.ownerLayers,
      workItems: sourceParent.mapping.workItems,
      clauseIds: capabilityClauses.map((candidate) => candidate.id).sort()
    }
  ];
  wmlFamily.capabilityClauses = capabilityClauses;
}
...
function refreshManifestTotals(manifest) {
  ...
  const countLevel = (level) => clauses.filter((clause) => clause.obligationLevel === level).length;
...
if (refreshWsp801Evidence) {
  ...
  const parentLedger = JSON.parse(parentLedgerText);
  const parentById = new Map(parentLedger.obligations.map((parent) => [parent.id, parent]));
  ...
  console.log(`Refreshed ${refreshed} WSP-801 clause evidence mappings in ${outputPath}`);
  process.exit(0);
}
...
if (refreshDirectWorkItems) {
  ...
  for (const family of manifest.families) {
    ...
    const parentById = new Map(parentLedger.obligations.map((parent) => [parent.id, parent]));
    family.parentLedgerSha256 = sha256(fs.readFileSync(family.parentLedger, 'utf8'));
    for (const parent of family.parents) {
      const source = parentById.get(parent.id);
      if (!source) {
    ...
    for (const candidate of family.clauses) {
      ...
      const aggregateContextWorkItems = aggregateContextWorkItemsForClause(candidate.id);
      ...
      candidate.mapping.workItems = [
        ...new Set([
          ...candidate.parentRows.flatMap((parentId) => parentById.get(parentId).mapping.workItems),
          ...directWorkItems
        ])
      ].sort();
      candidate.mapping.ownerLayers = [
        ...new Set(
          candidate.parentRows
            ...
            .concat(directWorkItems.includes('WSP-805') ? ['transport-rust'] : [])
        )
      ].sort();
      ...
      if (implementedWml203ClauseIds.has(candidate.id)) {
        ...
        const testPath = wml202TestPath(candidate.id, candidate.fixturePlan.kind);
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = {
          path: testPath,
          testPath,
          command: 'cargo test --manifest-path engine-wasm/engine/Cargo.toml wml_202'
        };
        ...
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = wsp801FixtureEvidence;
      } else if (implementedWsp802ClauseIds.has(candidate.id)) {
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = wsp802FixtureEvidence;
      } else if (implementedWml305ClauseIds.has(candidate.id)) {
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = wml305FixtureEvidence(candidate.id);
      } else if (implementedWml306NewClauseIds.has(candidate.id)) {
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = {
      ...
      } else if (implementedWmls502ClauseIds.has(candidate.id)) {
        candidate.fixturePlan.status = 'implemented';
        candidate.fixturePlan.evidence = wmls502FixtureEvidence;
      } else if (
      ...
      candidate.mapping.clauseImplementationStatus =
        candidate.fixturePlan.status === 'implemented' ? 'implemented' : 'not-assessed';
    }
    if (family.family === 'wml') {
      refreshWml306OptionalCapability(family, parentLedger);
    }
  }
  for (const family of manifest.families) {
    family.status = family.clauses.every(
...
const ingestion = readJson(`${manifestDirectory}/wap-1.2.1-ingestion-status.json`);
const externalIngestion = readJson(`${manifestDirectory}/wap-1.2.1-external-ingestion-status.json`);
const effectiveSpec = readJson(`${manifestDirectory}/wap-1.2.1-effective-spec.json`);
const classConformance = readJson(`${manifestDirectory}/wap-1.2.1-class-conformance.json`);
...
function normalizeSectionText(value) {
  return value
    .replace(/\f/g, '\n')
    .replace(/^WAP-\d+.*Page \d+.*$|^\s*.*$|^\s*All rights reserved\s*$/gm, '')
    .replace(/[ \t]+/g, ' ')
    .replace(/\n{3,}/g, '\n\n')
    .trim();
}
...
const sectionDefinitions = {
  wml: {
    ...
    ranges: {
      ...
      '9.10.1': ['9.10.1 The Onevent Element', '9.10.2 Card/Deck Intrinsic Events'],
      ...
      '10.3.1': ['10.3.1 Variable Substitution', '10.3.2 Parsing the Variable Substitution Syntax'],
      '10.3.2': [
        '10.3.2 Parsing the Variable Substitution Syntax',
        '10.3.3 The Dollar-sign Character'
      ],
      '10.3.3': ['10.3.3 The Dollar-sign Character', '10.3.4 Setting Variables'],
      ...
      '11.6.2.1': ['11.6.2.1 The Select Element', '11.6.2.2 The Option Element'],
      '11.6.2.2': ['11.6.2.2 The Option Element', '11.6.2.3 The Optgroup Element'],
      ...
      12.4: ['12.4 Unknown DTD', '12.5 Reference Processing Behaviour - Inter-card Navigation'],
      12.5: ['12.5 Reference Processing Behaviour - Inter-card Navigation', '12.5.1 The Go Task'],
      ...
      '12.5.5': ['12.5.5 Task Execution Failure', '13. WML Reference Information']
    }
  },
  wbxml: {
    ...
    ranges: {
      ...
      '5.8.2': ['5.8.2. Tag Code Space', '5.8.3. Attribute Code Space (ATTRSTART and ATTRVALUE)'],
      '5.8.3': ['5.8.3. Attribute Code Space (ATTRSTART and ATTRVALUE)', '5.8.4. Global Tokens'],
      '5.8.4': ['5.8.4. Global Tokens', '5.8.4.1. Strings'],
      '5.8.4.1': ['5.8.4.1. Strings', '5.8.4.2. Global Extension Tokens'],
      '5.8.4.2': ['5.8.4.2. Global Extension Tokens', '5.8.4.3. Character Entity'],
      '5.8.4.3': ['5.8.4.3. Character Entity', '5.8.4.4. Processing Instruction'],
      '5.8.4.4': ['5.8.4.4. Processing Instruction', '5.8.4.5. Literal Tag or Attribute Name'],
      '5.8.4.5': ['5.8.4.5. Literal Tag or Attribute Name', '5.8.4.6. Opaque Data'],
      '5.8.4.6': ['5.8.4.6. Opaque Data', '5.8.4.7. Miscellaneous Control Codes'],
      '5.8.4.7.1': ['5.8.4.7.1. END Token', '5.8.4.7.2. Code Page Switch Token'],
      '5.8.4.7.2': ['5.8.4.7.2. Code Page Switch Token', '6. Encoding Semantics'],
      6.3: [
        '6.3. Encoding Default Attribute Values',
        '6.4. Associating XML Documents with WBXML Token Values'
      ],
      6.4: ['6.4. Associating XML Documents with WBXML Token Values', '7. Numeric Constants']
    }
  },
  wae: {
    ...
    ranges: {
      ...
      '5.1.4': ['5.1.4 User Agent Characteristics', '5.1.5 Wireless Markup Language'],
      ...
      '5.1.8.1': ['5.1.8.1 Encoded WML format', '5.1.8.2 Encoded WMLScript format'],
      '5.1.8.2': [
  ...
  caching: {
    ...
    ranges: {
      ...
      6: ['6. Security Considerations', 'Appendix A. Static Conformance Requirements']
    }
  },
  wcmp: {
    ...
    ranges: {
      ...
      '5.5.1': ['5.5.1. General Message Structure', '5.5.2. Address Information Formats'],
      '5.5.2': ['5.5.2. Address Information Formats', '5.5.3. WCMP Messages'],
      '5.5.3.1': ['5.5.3.1. Destination Unreachable', '5.5.3.2. Parameter Problem'],
      '5.5.3.3': ['5.5.3.3. Message Too Big', '5.5.3.4. Reassembly Failure'],
      '5.5.3.5': [
  ...
  wsp: {
    ...
    ranges: {
      ...
      '6.4.3': ['6.4.3 Constraints on Using the Service Primitives', '6.4.4 Error Handling'],
      '6.4.4': ['6.4.4 Error Handling', '7 WSP Protocol Operations'],
      7.2: ['7.2 Connectionless WSP', '8 WSP Data Unit Structure and Encoding'],
      '8.1.1': ['8.1.1 Primitive Data Types', '8.1.2 Variable Length Unsigned Integers'],
      ...
      '8.4.2.70': ['8.4.2.70 Encoding-Version field', '8.4.3 Textual Header Syntax'],
      '8.4.3.1': ['8.4.3.1 Encoding-Version field', '8.4.4 End-to-end and Hop-by-hop Headers'],
      '8.4.4': ['8.4.4 End-to-end and Hop-by-hop Headers', '8.5 Multipart Data'],
      'appendix-a': ['Appendix A Assigned Numbers', 'Appendix B Header encoding examples']
    }
  },
  'wsp-sin-001': {
  ...
  'wmlscript-libraries': {
    ...
    ranges: {
      ...
      'appendix-a': ['Appendix A. Library Summary', 'Appendix B. Static Conformance Requirements']
    }
  },
  'rfc-768': {
  ...
  rfc792: {
    ...
    ranges: {
      ...
      'destination-unreachable': ['Destination Unreachable Message', 'Time Exceeded Message'],
  ...
  'rfc-2616': {
    ...
    ranges: {
      ...
      '13.1.3': ['13.1.3 Cache-control Mechanisms', '13.1.4 Explicit User Agent Warnings'],
      '13.1.4': [
      ...
      '13.2.1': ['13.2.1 Server-Specified Expiration', '13.2.2 Heuristic Expiration'],
      '13.2.2': ['13.2.2 Heuristic Expiration', '13.2.3 Age Calculations'],
      '13.2.3': ['13.2.3 Age Calculations', '13.2.4 Expiration Calculations'],
      '13.2.4': ['13.2.4 Expiration Calculations', '13.2.5 Disambiguating Expiration Values'],
      '13.2.5': [
        '13.2.5 Disambiguating Expiration Values',
        '13.2.6 Disambiguating Multiple Responses'
      ],
      '13.2.6': ['13.2.6 Disambiguating Multiple Responses', '13.3 Validation Model'],
      13.3: ['13.3 Validation Model', '13.3.1 Last-Modified Dates'],
      '13.3.1': ['13.3.1 Last-Modified Dates', '13.3.2 Entity Tag Cache Validators'],
      '13.3.2': ['13.3.2 Entity Tag Cache Validators', '13.3.3 Weak and Strong Validators'],
      '13.3.3': [
      ...
      '13.3.5': ['13.3.5 Non-validating Conditionals', '13.4 Response Cacheability'],
      13.4: ['13.4 Response Cacheability', '13.5 Constructing Responses From Caches'],
      '13.5.1': ['13.5.1 End-to-end and Hop-by-hop Headers', '13.5.2 Non-modifiable Headers'],
      '13.5.2': ['13.5.2 Non-modifiable Headers', '13.5.3 Combining Headers'],
...
function extractSection(anchorFamily, section) {
  ...
  const end = endHeading ? source.text.indexOf(`\n${endHeading}\n`, start + 1) : source.text.length;
  if (start === -1 || end === -1 || end <= start) {
    throw new Error(
      `${anchorFamily}/${section}: cannot resolve ${startHeading} -> ${endHeading ?? 'EOF'}`
    );
  }
  const normalized = normalizeSectionText(source.text.slice(start + 1, end));
  return {
...
for (const [anchorFamily, definition] of Object.entries(sectionDefinitions)) {
  for (const section of Object.keys(definition.ranges)) {
    sectionAnchors.set(`${anchorFamily}:${section}`, extractSection(anchorFamily, section));
  }
}
...
function clause(
  ...
  const directFixtureImplemented =
    ...
    implementedWml306NewClauseIds.has(clauseId) ||
    implementedWmls501ClauseIds.has(clauseId) ||
    implementedWmls502ClauseIds.has(clauseId);
  ...
  const evidence = implementedWml203ClauseIds.has(clauseId)
...
clause(
  ...
  'implicit-must',
  'parser',
  'Accept named, decimal numeric, and hexadecimal numeric WML character references.'
);
clause(
  'wml',
  'entity_unicode_identity',
  ['WML-C-06'],
  '6.2',
  'implicit-must',
  'parser',
...
clause(
  ...
  'explicit-must',
  'state-machine',
  'Maintain navigational history as an ordered stack of visited card request identities.'
);
clause(
  'wml',
  'history_duplicate_push',
  ['WML-C-07'],
  '9.2',
  'explicit-must',
  'state-machine',
  'Push an entry for each explicit card access even when it duplicates the newest history entry.'
);
clause(
  'wml',
  ...
  'explicit-must',
  'state-machine',
  'Record the absolute card URL, request method, submitted fields, and request headers in each history entry.'
);
clause(
  'wml',
  'history_excludes_content',
  ['WML-C-07'],
  '9.2',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'history_resolves_variables',
  ['WML-C-07'],
  '9.2',
  'explicit-must',
  'state-machine',
  'Resolve variable references before request data is stored in history.'
);
clause(
  'wml',
  'history_prev_pop',
...
clause(
  'wml',
  'intrinsic_attribute_equivalence',
  ['WML-C-09', 'WML-C-39'],
  '9.10',
  'explicit-must',
  'runtime',
...
clause(
  'wml',
  'intrinsic_card_overrides_template',
  ['WML-C-08', 'WML-C-09', 'WML-C-47'],
  '9.10.2',
  'implicit-must',
  'runtime',
...
clause(
  'wml',
  'newcontext_unset_variables',
  ['WML-C-11'],
  '10.2',
  'explicit-must',
  'state-machine',
  'On newcontext initialization, remove all variables from the current browser context.'
);
clause(
  'wml',
  'newcontext_clear_history',
  ['WML-C-11'],
  '10.2',
  'explicit-must',
  'state-machine',
...
clause(
  'wml',
  'newcontext_reset_private_state',
  ['WML-C-11'],
  '10.2',
  'explicit-must',
  'state-machine',
...
clause(
  'wml',
  'variable_substitution_locations',
  ['WML-C-12'],
  '10.3.1',
  'implicit-must',
  'parser',
...
clause(
  'wml',
  'variable_task_snapshot',
  ['WML-C-12', 'WML-C-18', 'WML-C-29', 'WML-C-38', 'WML-C-42', 'WML-C-52'],
  '10.3.4',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'variable_commit_before_task',
  ['WML-C-12', 'WML-C-33', 'WML-C-43'],
  '10.3.4',
  'explicit-must',
  'runtime',
...
clause(
  'wml',
  'external_navigation_new_context',
  ['WML-C-13'],
  '10.4',
  'explicit-must',
  'state-machine',
...
clause(
  'wml',
  'external_navigation_old_context',
  ['WML-C-13'],
  '10.4',
  'explicit-may',
  'state-machine',
...
clause(
  'wml',
  'access_single_element',
  ['WML-C-21'],
  '11.3.1',
  'error-condition',
  'parser',
  'Reject a deck containing more than one access element.'
);
clause(
  'wml',
  'access_absent_allows',
  ['WML-C-21'],
  '11.3.1',
  'implicit-must',
  'security-policy',
...
clause(
  'wml',
  'access_component_match',
  ['WML-C-21'],
  '11.3.1',
  'explicit-must',
  'security-policy',
  'Match domains by complete suffix components and paths by complete prefix components.'
);
clause(
  'wml',
  'access_defaults',
...
clause(
  'wml',
  'unknown_markup_ignored',
  ['WML-C-17'],
  '12.4',
  'explicit-should',
  'parser',
  'For an alternate DTD, ignore unrecognized element tags and attributes during presentation.'
);
clause(
  'wml',
...
clause(
  'wml',
  'go_access_before_transition',
  ['WML-C-14', 'WML-C-18', 'WML-C-29'],
  '12.5.1',
  'implicit-must',
  'security-policy',
...
clause(
  ...
  'implicit-must',
  'state-machine',
  'Apply temporary setvar assignments before newcontext processing and history insertion.'
);
clause(
  'wml',
  'go_history_push',
  ['WML-C-07', 'WML-C-18', 'WML-C-29'],
  '12.5.1',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'go_entry_event_precedence',
  ['WML-C-09', 'WML-C-18', 'WML-C-29'],
  '12.5.1',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'go_timer_then_display',
  ['WML-C-18', 'WML-C-29', 'WML-C-48'],
  '12.5.1',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'prev_entry_event_precedence',
  ['WML-C-09', 'WML-C-18', 'WML-C-38'],
  '12.5.2',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'refresh_timer_restart',
  ['WML-C-18', 'WML-C-42', 'WML-C-48'],
  '12.5.4',
  'implicit-must',
  'state-machine',
...
clause(
  'wml',
  'task_failure_atomicity',
  ['WML-C-16', 'WML-C-18', 'WML-C-29', 'WML-C-38'],
  '12.5.5',
  'explicit-must',
  'error-policy',
...
clause(
  'wml',
  'go_internal_postfield_suppression',
  ['WML-C-29'],
  '9.5.1',
  'explicit-must',
  'runtime',
...
clause(
  ...
  'implicit-must',
  'transport-boundary',
  'Support form-urlencoded submission and the declared multipart form-data behavior for POST requests.'
);
clause(
  'wml',
  'go_part_content_type',
  ['WML-C-29'],
  '9.5.1',
  'explicit-must',
  'transport-boundary',
  'Provide a content type for each multipart part and a charset when its content is not US-ASCII.'
);
clause(
  'wml',
  'go_accept_charset',
...
clause(
  ...
  'explicit-must',
  'transport-boundary',
  'For form-urlencoded GET, combine encoded fields with any existing query into a valid query component.'
);
clause(
  'wml',
  'go_post_content_type_charset',
  ['WML-C-29'],
  '9.5.1',
  'explicit-must',
  'transport-boundary',
...
clause(
  ...
  'implicit-must',
  'rendering',
  'Expose an active non-optional do as a uniquely activatable interface action without assuming a particular physical widget.'
);
clause(
  'wml',
  'do_type_acceptance',
...
clause(
  'wml',
  'do_label_best_effort',
  ['WML-C-26'],
  '9.7',
  'explicit-must',
  'rendering',
  'Make a best-effort to use a supplied do label when the interface action can be labeled.'
);
clause(
  'wml',
  'do_effective_name',
...
clause(
  'wml',
  'do_optional_permission',
  ['WML-C-26'],
  '9.7',
  'explicit-may',
  'rendering',
  'The user agent may omit a do explicitly marked optional.'
);
clause(
  'wml',
  'do_active_visibility',
  ['WML-C-26'],
  '9.7',
  'explicit-must',
  'rendering',
...
clause(
  ...
  'explicit-must',
  'rendering',
  'Do not expose an inactive do in a form the user can activate.'
);
...
clause(
  ...
  'explicit-should',
  'runtime',
  'When access keys are supported, assign usable requested keys where possible and focus or activate the corresponding anchor.'
);
clause(
  'wml',
  'a_go_equivalence',
  ...
  'implicit-must',
  'runtime',
  'Treat an a element as an anchor containing a go task without variable assignments.'
);
clause(
  'wml',
  'a_no_nesting',
...
clause(
  ...
  'grammar',
  'parser',
  'Require an HREF target on each a element and restrict its child content to the declared inline set.'
);
...
clause(
  ...
  'implicit-must',
  'runtime',
  'Apply optional root language metadata as the deck language input to inherited language resolution.'
);
clause(
  'wml',
  'head_structure',
...
clause(
  ...
  'implicit-must',
  'parser',
  'Treat head children as metadata and access-control information for the whole deck.'
);
clause(
  'wml',
  'template_structure',
...
clause(
  ...
  'explicit-should',
  'rendering',
  'Preserve significant card element order during presentation.'
);
clause(
  'wml',
  'card_id_fragment',
...
clause(
  ...
  'grammar',
  'parser',
  'Require one or more option or optgroup children in each select element.'
);
clause(
  'wml',
  'select_single_multi_mode',
  ['WML-C-43'],
  '11.6.2.1',
  'implicit-must',
  'runtime',
...
clause(
  'wml',
  'select_index_validation',
  ['WML-C-43'],
  '11.6.2.1',
  'implicit-must',
  'runtime',
  'Validate selection indices by removing non-integers, out-of-range entries, and duplicates.'
);
clause(
  'wml',
  'select_default_precedence',
  ['WML-C-43'],
  '11.6.2.1',
  'implicit-must',
  'runtime',
  'Choose initial selections in iname, ivalue, name, value, then single/multiple fallback order.'
);
clause(
  'wml',
  'select_variable_initialization',
  ['WML-C-43'],
  '11.6.2.1',
  'implicit-must',
  'runtime',
  'Initialize name from selected option values and iname from the validated selected indices.'
);
clause(
  'wml',
  'select_preselection',
  ...
  'implicit-must',
  'runtime',
  'Deselect all options and then select every positive validated default index.'
);
clause(
  'wml',
  'select_user_update',
...
clause(
  'wml',
  'input_rejection_atomicity',
  ['WML-C-33'],
  '11.6.3',
  'explicit-must',
  'runtime',
  'On invalid input, notify the user, preserve the original variable value, and allow another entry attempt.'
);
clause(
  'wml',
  ...
  'explicit-must',
  'runtime',
  'Initialize each input from a valid existing name variable or a valid default value, then preload the control.'
);
clause(
  'wml',
  'input_invalid_initial_value',
  ['WML-C-33'],
  '11.6.3',
  'explicit-must',
  'runtime',
...
clause(
  ...
  'explicit-must',
  'runtime',
  'Accept an empty committed input only when the effective mask and emptyok rules allow it.'
);
clause(
  'wml',
...
clause(
  'wml',
  'input_format_literals',
  ['WML-C-33'],
  '11.6.3',
  'explicit-must',
  'runtime',
  'Preserve escaped literal characters that form part of an accepted formatted input value.'
);
clause(
  'wml',
  'input_maxlength',
...
clause(
  ...
  'implicit-must',
  'runtime',
  'Interpret timer values in tenths of a second without requiring a particular scheduling resolution.'
);
clause(
  'wml',
  'timer_invalid_value',
  ...
  'explicit-must',
  'runtime',
  'Ignore a timer whose resolved timeout is not a non-negative integer, with zero disabling it.'
);
clause(
  'wml',
  'timer_refresh_resume',
  ['WML-C-48', 'WML-C-42'],
  '11.7',
  'explicit-must',
  'state-machine',
...
clause(
  'wml',
  'timer_initial_value_precedence',
  ['WML-C-48'],
  '11.7',
  'implicit-must',
  'state-machine',
  'Initialize a named timer from its set variable, otherwise from value; always use value when no name is declared.'
);
...
clause(
  ...
  'implicit-must',
  'rendering',
  'Apply wrap or nowrap behavior and provide a way to view complete non-wrapped lines.'
);
clause(
  'wml',
  'paragraph_nonbreaking_space',
  ['WML-C-36', 'WML-C-06'],
  '11.8.3',
  'explicit-must',
  'rendering',
...
clause(
  'wml',
  'paragraph_mode_inheritance',
  ['WML-C-36'],
  '11.8.3',
  'implicit-must',
  'rendering',
  'Inherit unspecified wrap mode from the previous significant paragraph and default the first paragraph to wrap.'
);
clause(
  'wml',
  'paragraph_alignment_default',
  ['WML-C-36'],
  '11.8.3',
  'implicit-must',
  'rendering',
  'Default unspecified paragraph alignment to left.'
);
clause(
  'wml',
  'paragraph_significant_break',
  ['WML-C-36'],
  '11.8.3',
  'explicit-must',
  'rendering',
  'Insert a line break between significant paragraph elements.'
);
clause(
  'wml',
  'paragraph_empty_ignored',
  ['WML-C-36'],
  '11.8.3',
  'explicit-should',
  'rendering',
...
clause(
  ...
  'grammar',
  'parser',
  'Require one or more tr children and prohibit nested table elements.'
);
clause(
  'wml',
  'table_exact_columns',
...
clause(
  'wml',
  'table_short_row_padding',
  ['WML-C-46', 'WML-C-50'],
  '11.8.5',
  'explicit-must',
  'rendering',
  'Pad a row containing too few cells with significant empty cells.'
);
clause(
  'wml',
  'table_long_row_aggregation',
  ['WML-C-46', 'WML-C-50'],
  '11.8.5',
  'explicit-must',
  'rendering',
  'Merge excess cells into the final declared column and place one inter-word space between merged cells.'
);
clause(
  'wml',
  'table_alignment_designators',
  ['WML-C-46'],
  '11.8.5',
  'implicit-must',
  'rendering',
  'Apply column alignment designators in order, default missing or unknown designators, and ignore extras.'
);
clause(
  'wml',
  'table_nonzero_gutter',
  ['WML-C-46'],
  '11.8.5',
  'explicit-must',
  'rendering',
  'When using traditional tabular layout, separate adjacent non-empty columns with a non-zero gutter.'
);
clause(
  'wml',
  'tr_structure',
...
clause(
  ...
  'implicit-must',
  'rendering',
  'Lay out an image within the surrounding text flow.'
);
clause(
  'wml',
  'image_local_precedence',
  ['WML-C-32'],
  '11.9',
  'implicit-must',
  'rendering',
  'Use an available localsrc representation before fetching the src resource.'
);
clause(
  'wml',
  'image_remote_fetch',
  ...
  'implicit-must',
  'transport-boundary',
  'When images are supported and no usable local representation exists, fetch the src URI for rendering.'
);
clause(
  'wml',
  'image_alt_fallback',
...
clause(
  ...
  'explicit-must',
  'transport-boundary',
  'Implement the HTTP Basic authentication scheme using the RFC 2616 authority selected by the effective WAE SIN chain.',
  'wae-sin-103'
);
clause(
  'wae',
  'auth_challenge_parsing',
  ['WAESpec-C-002'],
  '1.2',
  'explicit-must',
  'parser',
  'Parse one or more case-insensitive authentication schemes and their challenge parameters from WWW-Authenticate and Proxy-Authenticate fields.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'explicit-must',
  'parser',
  'Require every accepted Basic challenge to contain a quoted realm parameter while treating the parameter name case-insensitively.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_protection_space',
  ['WAESpec-C-002'],
  '1.2',
  'implicit-must',
  'security-policy',
  'Identify an authentication protection space by the case-sensitive realm value together with the canonical root URL of its server.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_challenge_selection',
  ['WAESpec-C-002'],
  '1.2',
  'explicit-must',
  'security-policy',
  'When several challenges are offered, select the strongest authentication scheme the user agent understands and request credentials for that challenge.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'implicit-must',
  'transport-boundary',
  'Send origin-server Basic credentials in Authorization and associate them only with the realm and protection space of the requested resource.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_proxy_credentials',
  ['WAESpec-C-002'],
  '1.2',
  'implicit-must',
  'transport-boundary',
  'Handle a 407 proxy challenge with Proxy-Authorization while keeping proxy credentials distinct from end-to-end origin credentials.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'implicit-must',
  'transport-boundary',
  'Encode Basic credentials as Base64 over the user identifier, one colon separator, and the password, without MIME line-length wrapping.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'grammar',
  'parser',
  'Reject a Basic user identifier containing a colon while allowing the password field to contain text, including additional colons.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'implicit-must',
  'security-policy',
  'Treat a Basic realm value as an opaque, case-sensitive string that is comparable only with realms on the same server.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_path_reuse_scope',
  ['WAESpec-C-002'],
  '2',
  'explicit-should',
  'security-policy',
  'Assume Basic credentials apply at or below the challenged Request-URI path depth, but never extend automatic reuse beyond the protection space.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_preemptive_reuse',
  ['WAESpec-C-002'],
  '2',
  'explicit-may',
  'transport-boundary',
  'Permit preemptive Authorization only for a request already known to fall within the matching Basic protection space.',
  'rfc-2617'
);
clause(
  'wae',
  ...
  'implicit-must',
  'runtime',
  'When credentials are rejected with a new 401 or 407 challenge, do not silently treat the response as authenticated; expose a retry decision.',
  'rfc-2617'
);
clause(
  'wae',
  'auth_secure_channel_warning',
  ['WAESpec-C-002'],
  '4.1',
  'explicit-should',
  'security-policy',
  'Treat Basic credentials as cleartext-equivalent and use the scheme only with an external secure channel or an explicit unsafe-compatibility decision.',
  'rfc-2617'
);
...
clause(
  ...
  'implicit-must',
  'transport-boundary',
  'Recognize the http URL scheme for resources named on HTTP origin servers.'
);
clause(
  'wae',
  'http_transport_independence',
  ['WAESpec-C-003'],
  '5.1.3',
  'implicit-must',
  'transport-boundary',
  'Do not infer the client-to-gateway protocol from an http URL; preserve the same resource identity across direct and gateway-backed transport.'
);
clause(
  'wae',
  'uri_hierarchical_components',
  ['WAESpec-C-003'],
  '3',
  'grammar',
  'parser',
  'Parse hierarchical URI references into scheme, authority, path, and optional query components without treating the path as a filesystem path.',
  'rfc-2396'
);
clause(
  'wae',
  ...
  'grammar',
  'parser',
  'Parse an http URL as a required host plus optional port, absolute path, and query following the http scheme authority delimiter.',
  'rfc-2616'
);
clause(
  'wae',
  ...
  'explicit-must',
  'transport-boundary',
  'Use port 80 when the http URL omits a port and supply slash as the request path when its absolute path is empty.',
  'rfc-2616'
);
clause(
  'wae',
  ...
  'explicit-must',
  'runtime',
  'Compare HTTP URIs octet-for-octet except for case-insensitive scheme and host, default-port equivalence, and empty-path equivalence to slash.',
  'rfc-2616'
);
clause(
  'wae',
  'http_gateway_or_direct',
  ['WAESpec-C-003'],
  '5.1.3',
  'implicit-must',
  'transport-boundary',
  'Allow the named origin resource to be reached through a WSP-to-HTTP gateway or directly from a server combining gateway and origin roles.'
);

clause(
  'wae',
  'accept_capability_headers',
  ['WAESpec-C-005', 'WAESpec-C-006', 'WAESpec-C-007'],
  '3.3',
  'implicit-must',
  'transport-boundary',
  'Convey supported media types, character sets, and languages through Accept, Accept-Charset, and Accept-Language request headers respectively.',
  'wae-sin-101'
);
clause(
  'wae',
  'accept_independent_of_uaprof',
  ['WAESpec-C-005', 'WAESpec-C-006', 'WAESpec-C-007'],
  '3.3',
  'implicit-must',
  'transport-boundary',
  'Support the three Accept capability headers regardless of whether the client also supports or sends a UAProf profile.',
  'wae-sin-101'
);
clause(
  'wae',
  ...
  'grammar',
  'transport-boundary',
  'Serialize supported response media types as exact type/subtype values or valid type and global wildcards with applicable media parameters.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_media_preferences',
  ['WAESpec-C-007'],
  '14.1',
  'implicit-must',
  'transport-boundary',
  'Encode media preferences with quality values from zero through one, default omitted quality to one, and preserve specificity precedence.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_charset_ranges',
  ['WAESpec-C-005'],
  '14.2',
  'grammar',
  'transport-boundary',
  'Serialize supported response character sets as registered charset names or wildcard, each optionally carrying a quality value.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_charset_defaults',
  ['WAESpec-C-005'],
  '14.2',
  'implicit-must',
  'transport-boundary',
  'Preserve the historical ISO-8859-1 implicit quality rule when Accept-Charset is present without either that charset or a wildcard.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_language_ranges',
  ['WAESpec-C-006'],
  '14.4',
  'grammar',
  'transport-boundary',
  'Serialize preferred natural languages as valid language ranges or wildcard, each optionally carrying a quality value.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_language_matching',
  ['WAESpec-C-006'],
  '14.4',
  'implicit-must',
  'runtime',
  'Apply exact-or-hyphen-prefix language matching and use the quality of the longest matching language range.',
  'rfc-2616'
);
clause(
  'wae',
  'accept_values_match_capability',
  ['WAESpec-C-005', 'WAESpec-C-006', 'WAESpec-C-007'],
  '5.1.4',
  'implicit-must',
  'transport-boundary',
  'Generate capability headers from the user agent configuration and supported decoders rather than advertising formats it cannot process.'
);

clause(
  'wae',
  'wml_language_delegate',
  ['WAESpec-C-015', 'WAESpec-C-017'],
  '5.1.5',
  'implicit-must',
  'runtime',
  'Process Wireless Markup Language using the effective selected WML 1.3 family ledger and its Class C user-agent requirements.'
);
clause(
  'wae',
  'wmlscript_language_delegate',
  ['WAESpec-C-016', 'WAESpec-C-017'],
  '5.1.6',
  'implicit-must',
  'runtime',
  'Process WMLScript using the effective selected WMLScript family ledger and its Class C interpreter requirements.'
);
clause(
  'wae',
  'wml_user_agent_composition',
  ['WAESpec-C-017'],
  '5.1.7.2',
  'implicit-must',
  'runtime',
...
clause(
  'wae',
  'media_type_dispatch',
  ['WAESpec-C-019', 'WAESpec-C-020', 'WAESpec-C-021'],
  '5.1.8',
  'implicit-must',
  'transport-boundary',
...
clause(
  ...
  'implicit-must',
  'transport-boundary',
  'Recognize application/vnd.wap.wbxml as generic WBXML content and route it to the WBXML decoder.'
);
clause(
  'wae',
  'wbxml_document_typing',
  ['WAESpec-C-019'],
  '5.1.8.1',
  'implicit-must',
  'binary-decoder',
  'Use decoded WBXML document typing rather than assuming generic WBXML is always WML.'
);
clause(
  'wae',
  'wmlc_media_type',
  ...
  'implicit-must',
  'transport-boundary',
  'Recognize application/vnd.wap.wmlc as encoded WML, decode it as WBXML, and pass the resulting WML deck to the engine.'
);
clause(
  'wae',
  'wmlscriptc_media_type',
  ['WAESpec-C-021'],
  '5.1.8.2',
  'implicit-must',
  'transport-boundary',
...
clause(
  ...
  'explicit-must',
  'transport-boundary',
  'Faithfully implement the HTTP/1.1 resource caching model imported by WAP-120.'
);
clause(
  'caching',
  'zero_byte_profile',
  ...
  'implicit-must',
  'runtime',
  'Apply WAP caching semantics even when configured with zero bytes of persistent cache capacity.'
);
clause(
  'caching',
  'expiration_and_validation',
  ['UACache-C-001'],
  '13',
  'implicit-must',
  'state-machine',
  'Use expiration to avoid unnecessary requests and validation to avoid retransmitting an unchanged full response.',
  'rfc-2616'
);
clause(
  'caching',
  'semantic_relaxation_explicit',
  ['UACache-C-001'],
  '13',
  'explicit-must',
  'runtime',
  'Relax semantic transparency only through an explicit protocol or user choice and expose required warnings for non-transparent cached responses.',
  'rfc-2616'
);
clause(
  'caching',
  'newest_applicable_response',
  ['UACache-C-001'],
  '13.1.1',
  'explicit-must',
  'state-machine',
  'Select the most up-to-date cached response applicable to the request before evaluating whether it can be reused.',
  'rfc-2616'
);
clause(
  'caching',
  'cache_reuse_conditions',
  ['UACache-C-001'],
  '13.1.1',
  'explicit-must',
  'state-machine',
  'Reuse a cached response only when it is fresh enough, successfully revalidated, or an explicitly permitted status or stale response.',
  'rfc-2616'
);
clause(
  'caching',
  'origin_unavailable_result',
  ['UACache-C-001'],
  '13.1.1',
  'explicit-must',
  'error-policy',
  'When the origin is unreachable, serve only a response valid under cache rules; otherwise return an error or warning describing the communication failure.',
  'rfc-2616'
);
clause(
  'caching',
  'stale_response_warning',
  ['UACache-C-001'],
  '13.1.2',
  'explicit-must',
  'runtime',
  'Attach and process a Warning whenever a cached response is neither first-hand nor fresh enough.',
  'rfc-2616'
);
clause(
  'caching',
  'warning_revalidation_lifecycle',
  ['UACache-C-001'],
  '13.1.2',
  'explicit-must',
  'state-machine',
  'Delete 1xx freshness warnings after successful revalidation while retaining 2xx warnings about entity or header characteristics.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Resolve apparently conflicting cache-control values using the most restrictive interpretation unless a directive explicitly relaxes transparency.',
  'rfc-2616'
);
clause(
  'caching',
  'user_override_explicit',
  ['UACache-C-001'],
  '13.1.4',
  'explicit-should',
  'runtime',
  'Do not default to stale or abnormally ineffective caching; enable such behavior only through an explicit user configuration.',
  'rfc-2616'
);
clause(
  'caching',
  'user_override_warning',
  ['UACache-C-001'],
  '13.1.4',
  'explicit-should',
  'rendering',
  'Indicate when a user cache override displays known-stale content or persistently reduces normal cache effectiveness.',
  'rfc-2616'
);
clause(
  'caching',
  'client_freshness_directives',
  ['UACache-C-001'],
  '13.1.6',
  'explicit-may',
  'transport-boundary',
  'Allow requests to constrain maximum response age and minimum remaining freshness or explicitly accept bounded stale responses.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Treat response Expires and Cache-Control max-age values as server-specified freshness limits for subsequent requests.',
  'rfc-2616'
);
clause(
  'caching',
  'always_stale_validation',
  ['UACache-C-001'],
  '13.2.1',
  'explicit-should',
  'state-machine',
  'Validate an entry before reuse when its explicit expiration time is already in the past.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-may',
  'state-machine',
  'Permit cautious heuristic freshness when explicit expiration is absent while respecting the RFC worst-case constraints.',
  'rfc-2616'
);
clause(
  'caching',
  'age_initial_calculation',
  ['UACache-C-001'],
  '13.2.3',
  'explicit-must',
  'state-machine',
  'Calculate corrected initial age conservatively from Date, Age, request time, response time, and apparent network delay.',
  'rfc-2616'
);
clause(
  'caching',
  'age_resident_calculation',
  ['UACache-C-001'],
  '13.2.3',
  'implicit-must',
  'state-machine',
  'Calculate current age as corrected initial age plus the time the response has resided in the local cache.',
  'rfc-2616'
);
clause(
  'caching',
  'freshness_lifetime_priority',
  ['UACache-C-001'],
  '13.2.4',
  'implicit-must',
  'state-machine',
  'Derive freshness lifetime from max-age before Expires and otherwise from a permitted heuristic.',
  'rfc-2616'
);
clause(
  'caching',
  'heuristic_warning_113',
  ['UACache-C-001'],
  '13.2.4',
  'explicit-must',
  'runtime',
  'Attach Warning 113 when serving a heuristically fresh response more than 24 hours old and that warning is not already present.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Treat a response as fresh only while its freshness lifetime is greater than its current age.',
  'rfc-2616'
);
clause(
  'caching',
  'fresh_variant_recency',
  ['UACache-C-001'],
  '13.2.5',
  'explicit-must',
  'state-machine',
  'When fresh responses for one representation have different validators, select the entry with the most recent Date value.',
  'rfc-2616'
);
clause(
  'caching',
  'older_revalidation_retry',
  ['UACache-C-001'],
  '13.2.6',
  'explicit-should',
  'transport-boundary',
  'If revalidation returns an apparently older Date, retry unconditionally with max-age zero or no-cache.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'transport-boundary',
  'Validate stale entries with a conditional request carrying the stored validator and interpret a match as a bodyless 304 response.',
  'rfc-2616'
);
clause(
  'caching',
  'unrefreshable_without_validator',
  ['UACache-C-001'],
  '13.3',
  'implicit-must',
  'state-machine',
  'Allow a response without a validator to be cached until expiration, but do not attempt conditional refresh after it becomes stale.',
  'rfc-2616'
);
clause(
  'caching',
  'last_modified_validator',
  ['UACache-C-001'],
  '13.3.1',
  'implicit-must',
  'transport-boundary',
  'Use Last-Modified as a date validator when it is the available validator for a cached representation.',
  'rfc-2616'
);
clause(
  'caching',
  'entity_tag_validator',
  ['UACache-C-001'],
  '13.3.2',
  'implicit-must',
  'transport-boundary',
  'Store ETag values with cached representations and send them in cache-conditional requests.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Use strong comparison where byte identity is required and weak comparison only where semantic equivalence is sufficient.',
  'rfc-2616'
);
clause(
  'caching',
  'validator_request_selection',
  ['UACache-C-001'],
  '13.3.4',
  'explicit-must',
  'transport-boundary',
  'Send an available entity tag in cache conditionals, use Last-Modified when it is the only validator, and send both when both exist.',
  'rfc-2616'
);
clause(
  'caching',
  'nonvalidator_headers',
  ['UACache-C-001'],
  '13.3.5',
  'implicit-must',
  'state-machine',
  'Do not use arbitrary response-header equality as cache validation beyond entity tags and the defined Last-Modified compatibility mechanism.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Permit storage of status 200, 203, 206, 300, 301, and 410 responses unless another cache rule prohibits it.',
  'rfc-2616'
);
clause(
  'caching',
  'other_status_cacheability',
  ['UACache-C-001'],
  '13.4',
  'explicit-must',
  'state-machine',
  'Do not reuse other response statuses unless an explicit expiration value or cache-control directive makes them cacheable.',
  'rfc-2616'
);
clause(
  'caching',
  'end_to_end_header_storage',
  ['UACache-C-001'],
  '13.5.1',
  'explicit-must',
  'state-machine',
  'Store and replay end-to-end response headers with cache entries while excluding hop-by-hop connection headers.',
  'rfc-2616'
);
clause(
  'caching',
  'nonmodifiable_headers',
  ['UACache-C-001'],
  '13.5.2',
  'explicit-must',
  'transport-boundary',
  'Preserve Content-Location, Content-MD5, ETag, Last-Modified, and Expires according to the non-modifiable header rules.',
  'rfc-2616'
);
clause(
  'caching',
  'validated_header_merge',
  ['UACache-C-001'],
  '13.5.3',
  'explicit-must',
  'state-machine',
  'On 304 or compatible 206 validation, reuse the stored entity and replace cached end-to-end headers with corresponding new values.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-may',
  'state-machine',
  'Combine partial ranges only when both pieces have strongly matching validators; otherwise retain only the most recent partial response.',
  'rfc-2616'
);
clause(
  'caching',
  'vary_selection_match',
  ['UACache-C-001'],
  '13.6',
  'explicit-must',
  'state-machine',
  'Reuse a Vary-governed response only when every selecting request header matches the stored request after allowed whitespace normalization.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-must',
  'state-machine',
  'Treat Vary asterisk as an unconditional cache-selection miss that requires origin-server interpretation.',
  'rfc-2616'
);
clause(
  'caching',
  'private_cache_isolation',
  ['UACache-C-001', 'UACache-C-006'],
  '13.7',
  'explicit-should',
  'security-policy',
  'Enforce that a non-shared user-agent cache is accessible only to its single user through appropriate security mechanisms.',
  'rfc-2616'
);
clause(
  'caching',
  'partial_response_marking',
  ['UACache-C-001'],
  '13.8',
  'explicit-must',
  'state-machine',
  'Treat an incomplete stored response as partial and never return it as 200 OK instead of explicitly marked 206 Partial Content.',
  'rfc-2616'
);
clause(
  'caching',
  'revalidation_5xx_policy',
  ['UACache-C-001'],
  '13.8',
  'explicit-may',
  'error-policy',
  'On a 5xx validation response, forward the error or use a prior response only when must-revalidate does not forbid stale reuse.',
  'rfc-2616'
);
clause(
  'caching',
  'query_response_freshness',
  ['UACache-C-001'],
  '13.9',
  'explicit-must',
  'state-machine',
  'Do not treat a GET or HEAD query-URI response as fresh unless the server supplies an explicit expiration time.',
  'rfc-2616'
);
clause(
  'caching',
  'unsafe_method_invalidation',
  ['UACache-C-001'],
  '13.10',
  'explicit-must',
  'state-machine',
  'Invalidate cached entities affected by successful PUT, DELETE, or POST requests, including same-host Location and Content-Location targets.',
  'rfc-2616'
);
clause(
  'caching',
  'unknown_method_invalidation',
  ['UACache-C-001'],
  '13.10',
  'explicit-should',
  'state-machine',
  'Invalidate the Request-URI cache entry when passing through an unsafe method whose semantics are not understood.',
  'rfc-2616'
);
clause(
  'caching',
  'write_through_unsafe_methods',
  ['UACache-C-001'],
  '13.11',
  'explicit-must',
  'transport-boundary',
  'Write every potentially modifying method through to the origin and wait for its response instead of answering from cache.',
  'rfc-2616'
);
clause(
  'caching',
  'new_response_replacement',
  ['UACache-C-001'],
  '13.12',
  'explicit-should',
  'state-machine',
  'Use a newly received cacheable response for the current request and do not replace an entry with a response carrying an older Date.',
  'rfc-2616'
);
clause(
  'caching',
  'history_cache_distinction',
  ['UACache-C-001', 'UACache-C-002', 'UACache-C-003'],
  '13.13',
  'explicit-should',
  'state-machine',
  'Keep history distinct from ordinary cache reuse so back navigation normally restores what the user previously saw.',
  'rfc-2616'
);
clause(
  'caching',
  'cache_control_passthrough',
  ['UACache-C-001'],
  '14.9',
  'explicit-must',
  'transport-boundary',
  'Parse and pass Cache-Control directives through the request and response chain even when a local component does not use them.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-must',
  'state-machine',
  'Do not reuse a no-cache response without successful origin revalidation, including any field-name-limited restrictions.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-must',
  'security-policy',
  'For no-store, retain no message data in non-volatile cache and make a best effort to purge it promptly from volatile cache.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-must',
  'security-policy',
  'Never store a private response in a shared cache while permitting storage in the selected single-user cache.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'implicit-must',
  'state-machine',
  'Give response max-age precedence over Expires and use the lesser value when both request and response specify max-age.',
  'rfc-2616'
);
clause(
  'caching',
  'cache_control_reload',
  ['UACache-C-001'],
  '14.9',
  'explicit-must',
  'transport-boundary',
  'Map request no-cache to end-to-end reload and max-age zero to end-to-end revalidation, carrying a local validator when available.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-should',
  'error-policy',
  'For only-if-cached, return a compliant stored response or a 504 result without contacting the origin.',
  'rfc-2616'
);
clause(
  'caching',
  'cache_control_must_revalidate',
  ['UACache-C-001', 'UACache-C-002'],
  '14.9',
  'explicit-must',
  'state-machine',
  'Never reuse a stale must-revalidate entry without successful end-to-end validation; return an error when the origin cannot be reached.',
  'rfc-2616'
);
clause(
  'caching',
  ...
  'explicit-must',
  'transport-boundary',
  'Do not transform an entity body or its governed representation headers when no-transform is present.',
  'rfc-2616'
);
clause(
  'caching',
  'cache_control_extensions',
  ['UACache-C-001'],
  '14.9',
  'explicit-must',
  'parser',
  'Ignore unrecognized cache directives while continuing to obey accompanying standard directives that provide safe fallback behavior.',
  'rfc-2616'
);

clause(
  'caching',
  'history_cached_attempt',
  ['UACache-C-002', 'UACache-C-003'],
  '4.1.1',
  'explicit-should',
  'state-machine',
  'On WML back navigation, first attempt to restore the resource associated with the history entry from cache.'
);
clause(
  'caching',
  'history_must_revalidate',
  ['UACache-C-002'],
  '4.1.1',
  'explicit-must',
  'state-machine',
  'Revalidate a stale history resource before back navigation when its cached response carries must-revalidate.'
);
clause(
  'caching',
  'history_request_replay',
  ['UACache-C-002'],
  '4.1.1',
  'explicit-must',
  'transport-boundary',
  'Revalidate history with precisely the original method, request entity, and other request semantics, including POST data.'
);
clause(
  'caching',
  'history_revalidation_no_prompt',
  ['UACache-C-002'],
  '4.1.1',
  'explicit-must',
  'runtime',
  'Perform required history revalidation without asking the user to resubmit or confirm the original request.'
);
clause(
  'caching',
  'history_no_revalidate_without_directive',
  ['UACache-C-003'],
  '4.1.1',
  'explicit-must',
  'state-machine',
  'Do not revalidate a stale history resource during back navigation when must-revalidate is absent.'
);
clause(
  'caching',
  'history_snapshot_or_current',
  ['UACache-C-002', 'UACache-C-003'],
  '4.1.1',
  'implicit-must',
  'state-machine',
  'Show the historical cached representation by default and the up-to-date representation only when must-revalidate requires it.'
);
clause(
  'caching',
  'intra_resource_no_revalidate',
  ['UACache-C-004'],
  '4.1.2',
  'implicit-must',
  'state-machine',
  'Do not revalidate while navigating or processing within one cached resource unless that content type defines another validation model.'
);
clause(
  'caching',
  'wmlscript_intra_unit',
  ['UACache-C-004'],
  '4.1.2',
  'implicit-must',
  'runtime',
  'Allow calls within one WMLScript compilation unit without revalidation after the initial validity check and fetch.'
);
clause(
  'caching',
  'wml_intra_deck',
  ...
  'implicit-must',
  'runtime',
  'Allow navigation among cards in one WML deck without revalidation after the initial deck validity check and fetch.'
);
clause(
  'caching',
  ...
  'explicit-must',
  'security-policy',
  'Protect private information stored in the user-agent cache from unintended or malicious access.'
);
clause(
  'caching',
  'cache_nonvolatile_boundary',
  ['UACache-C-006'],
  '6',
  'implicit-must',
  'security-policy',
  'Apply access protection to sensitive cache data that survives in non-volatile storage, including data retained across browser restarts.'
);
...
clause(
  'wsp',
  'device_connectionless_mode',
  ['WSP-C-001', 'WSP-CL-C-001'],
  '6.4.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wsp',
  'connectionless_method_facility',
  ['WSP-CL-C-001', 'WSP-CL-C-004', 'WSP-CL-C-005', 'WSP-CL-C-006', 'WSP-CL-C-007'],
  '6.4.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  ...
  ['WSP-CL-C-004', 'WSP-CL-C-006'],
  '6.4.2.1',
  'table',
  'transport-boundary',
  'Carry server address, client address, transaction identifier, method, request URI, optional headers, and method-permitted request body.'
);
clause(
  'wsp',
  'method_invoke_transparency',
  ['WSP-CL-C-004', 'WSP-CL-C-006'],
  '6.4.2.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wsp',
  'method_http_semantics',
  ['WSP-CL-C-004', 'WSP-CL-C-006'],
  '6.4.2.1',
  'implicit-must',
  'transport-boundary',
  'Represent the method, request headers, and request body with semantics equivalent to their HTTP/1.1 counterparts.'
);
clause(
  'wsp',
  'method_body_constraint',
  ['WSP-CL-C-004', 'WSP-CL-C-006'],
  '6.4.2.1',
  'explicit-must',
  'error-policy',
...
clause(
  'wsp',
  'method_result_parameters',
  ['WSP-CL-C-005', 'WSP-CL-C-007'],
  '6.4.2.2',
  'table',
  'transport-boundary',
...
clause(
  ...
  'explicit-should',
  'rendering',
  'When a result status is an error, preserve any response body that supplies human-displayable error information.'
);
clause(
  'wsp',
  'primitive_role_restrictions',
  ['WSP-CL-C-001', 'WSP-CL-C-004', 'WSP-CL-C-005', 'WSP-CL-C-006', 'WSP-CL-C-007'],
  '6.4.3',
  'grammar',
  'transport-boundary',
...
clause(
  'wsp',
  'unitdata_receive_dispatch',
  ['WSP-CL-C-001', 'WSP-CL-C-005', 'WSP-CL-C-007'],
  '7.2',
  'table',
  'transport-boundary',
  'Dispatch received method and reply PDUs to their corresponding method-invoke and method-result indication primitives.'
);
clause(
  'wsp',
  'transport_error_ignored',
  ['WSP-CL-C-001'],
  '7.2',
  'table',
  'error-policy',
...
clause(
  'wsp',
  'integer_network_order',
  ['WSP-CL-C-001', 'WSP-CL-C-003'],
  '8.1.1',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wsp',
  'connectionless_tid_required',
  ['WSP-CL-C-004', 'WSP-CL-C-005', 'WSP-CL-C-006', 'WSP-CL-C-007'],
  '8.2.1',
  'explicit-must',
  'binary-decoder',
  'Include the one-octet transaction identifier before the PDU type in every selected connectionless method or reply PDU.'
);
clause(
  'wsp',
  'tid_peer_correlation',
  ['WSP-CL-C-004', 'WSP-CL-C-005', 'WSP-CL-C-006', 'WSP-CL-C-007'],
  '8.2.1',
  'implicit-must',
  'state-machine',
  'Pass the TID transparently through service primitives and use it to associate a reply with its connectionless request.'
);
clause(
  'wsp',
  'pdu_type_dispatch',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Encode the selected HTTP GET method using the Get PDU format.'
);
clause(
  'wsp',
  'get_pdu_layout',
  ...
  'grammar',
  'binary-decoder',
  'Encode Get contents as a uintvar URI length, exactly that many URI octets, then request headers through the end of the SDU.'
);
clause(
  'wsp',
  'get_uri_no_nul',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Encode the selected HTTP POST method using the Post PDU format.'
);
clause(
  'wsp',
  'post_pdu_layout',
  ...
  'grammar',
  'binary-decoder',
  'Encode Post contents as URI length, combined Content-Type-plus-headers length, URI, Content-Type, headers, then body data.'
);
clause(
  'wsp',
  'post_uri_no_nul',
...
clause(
  'wsp',
  'post_body_to_sdu_end',
  ['WSP-CL-C-006'],
  '8.2.3.2',
  'implicit-must',
  'binary-decoder',
  'Treat every octet after the declared headers as request body data through the end of the transport SDU.'
);
clause(
  'wsp',
  'reply_pdu_layout',
  ...
  'grammar',
  'binary-decoder',
  'Encode Reply contents as status, combined Content-Type-plus-headers length, Content-Type, headers, then response data.'
);
clause(
  'wsp',
  'reply_status_assignment',
  ['WSP-CL-C-005', 'WSP-CL-C-007'],
  'appendix-a',
  'table',
  'binary-decoder',
...
clause(
  'wsp',
  'reply_content_type',
  ['WSP-CL-C-005', 'WSP-CL-C-007', 'WSP-CL-C-003'],
  '8.2.3.3',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wsp',
  'header_name_version_choice',
  ['WSP-CL-C-003', 'WSP-CL-C-020'],
  '8.4.1.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wsp',
  'header_extension_page_agreement',
  ['WSP-CL-C-003'],
  '8.4.1.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wsp',
  'header_value_encoding_choice',
  ['WSP-CL-C-003'],
  '8.4.1.2',
  'explicit-must',
  'binary-decoder',
  'Use compact syntax for well-known binary field values and textual values whenever the field name is encoded as text.'
);
clause(
  'wsp',
  'header_value_length_prefix',
  ['WSP-CL-C-003'],
  '8.4.1.2',
  'table',
  'binary-decoder',
...
clause(
  'wsp',
  'encoding_version_required',
  ['WSP-CL-C-020'],
  '8.4.2.70',
  'explicit-must',
  'transport-boundary',
  'Include the hop-by-hop Encoding-Version header in every connectionless request and reply.'
);
clause(
  'wsp',
  'encoding_version_absent_default',
  ['WSP-CL-C-020'],
  '8.4.2.70',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wsp',
  'encoding_version_client_selection',
  ['WSP-CL-C-020'],
  '8.4.2.70',
  'explicit-must',
  'transport-boundary',
...
clause(
  'wsp',
  'encoding_version_extension_pages',
  ['WSP-CL-C-020'],
  '8.4.2.70',
  'explicit-should',
  'transport-boundary',
...
clause(
  'wsp',
  'encoding_version_peer_cache',
  ['WSP-CL-C-020'],
  '8.4.2.70',
  'explicit-may',
  'state-machine',
  'Cache the server-supported encoding version and use it to choose compatible encodings on later requests.'
);
clause(
  'wsp',
  'unsupported_encoding_retry',
  ['WSP-CL-C-003', 'WSP-CL-C-020'],
  '8.4.2.70',
  'implicit-must',
  'error-policy',
...
clause(
  'wdp',
  'consistent_transport_service',
  ['WDP-C-001', 'WDP-CORE-C-001'],
  '5.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'application_port_addressing',
  ['WDP-CORE-C-001', 'WDP-NA-C-006', 'WDP-NA-C-007'],
  '5.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  ...
  ['WDP-C-001', 'WDP-CORE-C-001', 'WDP-NA-C-006', 'WDP-NA-C-007'],
  '5.2',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'adaptation_layer_boundary',
  ['WDP-C-001', 'WDP-CT-C-002'],
  '5.2',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'ip_bearer_requires_udp',
  ['WDP-C-001', 'WDP-CT-C-002', 'WDP-NA-C-003'],
  '5.3',
  'explicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'unitdata_indication_parameters',
  [
    'WDP-CORE-C-001',
    'WDP-PF-C-002',
    'WDP-NA-C-000',
  ...
  'table',
  'transport-boundary',
  'Deliver source address, source port, and user data on T-DUnitdata indication, with destination address and port when available.'
);
clause(
  'wdp',
  'destination_address_semantics',
  ['WDP-PF-C-001', 'WDP-PF-C-002', 'WDP-NA-C-000', 'WDP-NA-C-003'],
  '6.3.1.1',
  'implicit-must',
  'transport-boundary',
  'Treat the destination address as the network identity of the receiving device for the submitted user data.'
);
clause(
  'wdp',
  'source_address_semantics',
  ['WDP-PF-C-001', 'WDP-PF-C-002', 'WDP-NA-C-000', 'WDP-NA-C-003'],
  '6.3.1.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'destination_port_semantics',
  ['WDP-PF-C-001', 'WDP-PF-C-002', 'WDP-NA-C-006'],
  '6.3.1.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  ...
  ['WDP-PF-C-001', 'WDP-PF-C-002', 'WDP-NA-C-007'],
  '6.3.1.1',
  'implicit-must',
  'transport-boundary',
  'Bind the source port to the requesting application or upper-layer protocol for that communication instance.'
);
clause(
  'wdp',
  'unitdata_content_transparency',
  ['WDP-CORE-C-001', 'WDP-PF-C-001', 'WDP-PF-C-002'],
  '6.3.1.1',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'ip_mapping_fragmentation',
  ['WDP-C-001', 'WDP-CT-C-002', 'WDP-NA-C-003'],
  '7.2',
  'implicit-must',
  'transport-boundary',
  'Rely on IPv4 fragmentation and reassembly below UDP rather than adding a second WDP segmentation header on the CDPD/IP path.'
);
clause(
  'wdp',
  'wap_port_registry',
...
clause(
  'wdp',
  'udp_destination_port_context',
  ['WDP-NA-C-006', 'WDP-NA-C-003'],
  'fields',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'udp_checksum_padding',
  ['WDP-CORE-C-001'],
  'fields',
  'implicit-must',
  'binary-decoder',
  'Zero-pad an odd checksum input to a two-octet boundary without transmitting the padding octet.',
  'rfc-768'
);
clause(
  'wdp',
  'udp_checksum_zero_encoding',
  ['WDP-CORE-C-001'],
  'fields',
  'implicit-must',
  'binary-decoder',
  'Transmit an arithmetically computed zero UDP checksum as all one bits.',
  'rfc-768'
);
clause(
  'wdp',
  'udp_checksum_omission',
  ['WDP-CORE-C-001'],
  'fields',
  'explicit-may',
  'binary-decoder',
...
clause(
  'wdp',
  'udp_receive_interface',
  ['WDP-PF-C-002', 'WDP-NA-C-003', 'WDP-NA-C-007'],
  'interface',
  'explicit-should',
  'transport-boundary',
...
clause(
  'wdp',
  'udp_send_interface',
  ['WDP-PF-C-001', 'WDP-NA-C-003', 'WDP-NA-C-006', 'WDP-NA-C-007'],
  'interface',
  'explicit-should',
  'transport-boundary',
...
clause(
  'wdp',
  'ipv4_independent_datagrams',
  ['WDP-C-001', 'WDP-CORE-C-001', 'WDP-NA-C-003'],
  '1.4',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wdp',
  'ipv4_fixed_address_size',
  ['WDP-NA-C-000', 'WDP-NA-C-003'],
  '2.3',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wdp',
  'ipv4_fragment_reassembly_key',
  ['WDP-CORE-C-001', 'WDP-NA-C-003'],
  '3.2',
  'implicit-must',
  'binary-decoder',
  'Group IPv4 fragments by identification, source, destination, and protocol, then place data using fragment offsets and the final-fragment marker.',
  'rfc-791'
);
clause(
  'wdp',
  ...
  'explicit-must',
  'error-policy',
  'Do not fragment a datagram whose DF bit is set; discard it when the route cannot carry it intact.',
  'rfc-791'
);
clause(
  'wdp',
  ...
  'explicit-must',
  'error-policy',
  'Destroy an IPv4 datagram when its time-to-live value reaches zero.',
  'rfc-791'
);
clause(
  'wdp',
  ...
  'explicit-must',
  'binary-decoder',
  'Verify the ones-complement IPv4 header checksum and discard a datagram immediately when verification fails.',
  'rfc-791'
);
clause(
  'wdp',
  'ipv4_source_destination_fields',
  ['WDP-PF-C-001', 'WDP-PF-C-002', 'WDP-NA-C-003'],
  '3.1',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'conversion_string_numeric_grammar',
  ['WMLS-C-072'],
  '6.8.2',
  'explicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'conversion_integer_string_grammar',
  ['WMLS-C-073'],
  '6.8.3',
  'explicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'conversion_invalid_propagation',
  ['WMLS-C-076', 'WMLS-C-077'],
  '6.8.6',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'conversion_summary_matrix',
  ['WMLS-C-072', 'WMLS-C-073', 'WMLS-C-075', 'WMLS-C-076'],
  '6.8.7',
  'table',
  'runtime',
...
clause(
  'wmlscript',
  'operator_numeric_precedence',
  ['WMLS-C-077'],
  '6.9',
  'table',
  'runtime',
  'Apply string, floating-point, and integer operation precedence exactly for multi-typed arithmetic, addition, and comparison operands.'
);
clause(
  'wmlscript',
  'operator_conversion_result_invalid',
  ['WMLS-C-077'],
  '6.9',
  'implicit-must',
  'runtime',
  'Return invalid when a selected legal conversion itself produces invalid.'
);

clause(
  'wmlscript',
  'url_named_compilation_units',
  ['WMLS-C-078'],
  '8.3',
  'implicit-must',
  'transport-boundary',
...
clause(
  'wmlscript',
  'fragment_document_form',
  ['WMLS-C-079'],
  '8.3.2',
  'grammar',
  'parser',
  'Parse a function fragment after a hash mark appended to the compilation-unit URL.'
);
clause(
  'wmlscript',
  'url_call_grammar',
...
clause(
  'wmlscript',
  'url_call_unescape_before_parse',
  ['WMLS-C-080'],
  '8.3.5',
  'explicit-must',
  'parser',
...
clause(
  'wmlscript',
  'url_call_access_first',
  ['WMLS-C-081', 'WMLS-C-087'],
  '8.3.4',
  'implicit-must',
  'security-policy',
...
clause(
  'wmlscript',
  'url_call_external_match',
  ['WMLS-C-079', 'WMLS-C-081', 'WMLS-C-087'],
  '8.3.4',
  'implicit-must',
  'runtime',
  'Match the fragment function name only against externally callable functions and fail when no match exists.'
);
clause(
  'wmlscript',
  'url_call_typed_arguments',
  ['WMLS-C-081'],
  '8.3.4',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'url_call_invalid_parameters',
  ['WMLS-C-080', 'WMLS-C-081'],
  '8.3.4',
  'error-condition',
  'error-policy',
  'Fail a URL call when its parameter list has invalid syntax or does not match the target function arity.'
);
clause(
  'wmlscript',
  'relative_url_resolution',
  ['WMLS-C-082'],
  '8.3.6',
  'explicit-must',
  'transport-boundary',
...
clause(
  'wmlscript',
  'argument_stack_order',
  ['WMLS-C-083'],
  '8.4.1',
  'explicit-must',
  'runtime',
  'Push function arguments onto the operand stack in declaration order, beginning with the first argument.'
);
clause(
  'wmlscript',
  'argument_call_initialization',
  ['WMLS-C-083'],
  '8.4.1',
  'explicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'external_keyword_gate',
  ['WMLS-C-087'],
  '8.5',
  'explicit-must',
  'security-policy',
  'Permit calls from another compilation unit only to functions marked external.'
);
clause(
  'wmlscript',
  'access_domain_path_gate',
  ['WMLS-C-087'],
  '8.5',
  'explicit-must',
  'security-policy',
...
clause(
  'wmlscript',
  'binary_data_type_registry',
  ['WMLS-C-088'],
  '9.1.1',
  'table',
  'binary-decoder',
  'Decode every defined bit, byte, signed, unsigned, multi-byte integer, and float32 field type with its specified width and representation.'
);
clause(
  'wmlscript',
  'binary_network_order',
  ['WMLS-C-088'],
  '9.1.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'multibyte_integer_continuation',
  ['WMLS-C-089'],
  '9.1.2',
  'grammar',
  'binary-decoder',
...
clause(
  'wmlscript',
  'multibyte_integer_unused_zero',
  ['WMLS-C-089'],
  '9.1.2',
  'explicit-must',
  'binary-decoder',
  'Require unused value bits in the initial multi-byte integer octet to be zero.'
);
clause(
  'wmlscript',
  'character_set_mibenum',
  ['WMLS-C-090'],
  '9.1.3',
  'implicit-must',
  'binary-decoder',
  'Interpret encoded character-set identities as IANA MIBenum values.'
);
clause(
  'wmlscript',
  'character_set_native_execution',
  ['WMLS-C-069', 'WMLS-C-090'],
  '8.2',
  'explicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'bytecode_section_order',
  ['WMLS-C-069', 'WMLS-C-091', 'WMLS-C-092', 'WMLS-C-093', 'WMLS-C-094'],
  '9.2',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'constant_pool_charset',
  ['WMLS-C-090', 'WMLS-C-092'],
  '9.4',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'constant_type_registry',
  ['WMLS-C-092'],
  '9.4',
  'table',
  'binary-decoder',
  'Decode constant types 0 through 6 as signed integers, float32, UTF-8 string, empty string, or externally encoded string, and reject reserved types.'
);
clause(
  'wmlscript',
  'constant_integer_widths',
  ['WMLS-C-092'],
  '9.4',
  'table',
  'binary-decoder',
  'Decode signed integer constants in the selected 8-bit, 16-bit, or 32-bit two-complement representation.'
);
clause(
  'wmlscript',
  'constant_string_lengths',
  ['WMLS-C-090', 'WMLS-C-092'],
  '9.4',
  'grammar',
  'binary-decoder',
...
clause(
  'wmlscript',
  'constant_embedded_null',
  ['WMLS-C-092'],
  '9.4',
  'explicit-must',
  'binary-decoder',
  'Preserve embedded null characters inside length-delimited WMLScript string constants.'
);
clause(
  'wmlscript',
  'pragma_pool_count',
...
clause(
  'wmlscript',
  'pragma_access_uniqueness',
  ['WMLS-C-087', 'WMLS-C-093'],
  '9.5',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'pragma_string_indexes',
  ['WMLS-C-093'],
  '9.5',
  'explicit-must',
  'binary-decoder',
  'Require access and meta pragma indexes to reference string constants of the permitted constant types.'
);
clause(
  'wmlscript',
  'function_pool_count',
...
clause(
  'wmlscript',
  'function_name_table',
  ['WMLS-C-079', 'WMLS-C-087', 'WMLS-C-094'],
  '9.6',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'function_record_boundaries',
  ['WMLS-C-094', 'WMLS-C-107'],
  '9.6',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'control_flow_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-095'],
  '10.5.1',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'function_call_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-096'],
  '10.5.2',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'function_call_index_types',
  ['WMLS-C-096', 'WMLS-C-108'],
  '10.5.2',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'variable_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-097'],
  '10.5.3',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'variable_instruction_bounds',
  ['WMLS-C-097', 'WMLS-C-108'],
  '10.5.3',
  'explicit-must',
  'error-policy',
...
clause(
  'wmlscript',
  'constant_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-098'],
  '10.5.4',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'constant_instruction_bounds',
  ['WMLS-C-098', 'WMLS-C-108'],
  '10.5.4',
  'explicit-must',
  'error-policy',
...
clause(
  'wmlscript',
  'arithmetic_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-099'],
  '10.5.5',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'arithmetic_invalid_results',
  ['WMLS-C-077', 'WMLS-C-099', 'WMLS-C-111'],
  '10.5.5',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'bitwise_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-100'],
  '10.5.6',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'bitwise_integer_results',
  ['WMLS-C-077', 'WMLS-C-100'],
  '10.5.6',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'comparison_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-101'],
  '10.5.7',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'comparison_invalid_result',
  ['WMLS-C-077', 'WMLS-C-101'],
  '10.5.7',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'logical_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-102'],
  '10.5.8',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'logical_boolean_conversion',
  ['WMLS-C-077', 'WMLS-C-102'],
  '10.5.8',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'stack_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-103'],
  '10.5.9',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'stack_underflow_fatal',
  ['WMLS-C-103', 'WMLS-C-110'],
  '10.5.9',
  'error-condition',
  'error-policy',
...
clause(
  'wmlscript',
  'operand_type_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-104'],
  '10.5.10',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'return_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-105'],
  '10.5.11',
  'table',
  'binary-decoder',
...
clause(
  'wmlscript',
  'return_top_level_boundary',
  ['WMLS-C-085', 'WMLS-C-105'],
  '10.5.11',
  'implicit-must',
  'runtime',
...
clause(
  'wmlscript',
  'debug_instruction_matrix',
  ['WMLS-C-069', 'WMLS-C-106'],
  '10.5.12',
  'table',
  'binary-decoder',
  'Recognize the effective debug opcode and perform its specified no-semantic-operation behavior without corrupting interpreter state.'
);

clause(
  'wmlscript',
  'integrity_before_execution',
  ['WMLS-C-107'],
  '11.1',
  'explicit-must',
  'error-policy',
  'Complete bytecode integrity verification before executing the compilation unit.'
);
clause(
  'wmlscript',
  'integrity_version_check',
  ['WMLS-C-091', 'WMLS-C-107'],
  '11.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'integrity_code_size_check',
  ['WMLS-C-091', 'WMLS-C-107'],
  '11.1',
  'explicit-must',
  'binary-decoder',
  'Require the declared bytecode size to match the available compilation-unit bytes.'
);
clause(
  'wmlscript',
  'integrity_pool_counts',
  ['WMLS-C-092', 'WMLS-C-093', 'WMLS-C-094', 'WMLS-C-107'],
  '11.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wmlscript',
  'integrity_failure_quarantine',
  ['WMLS-C-107', 'WMLS-C-110'],
  '11.1',
  'explicit-must',
  'error-policy',
...
clause(
  'wmlscript',
  'runtime_jump_validity',
  ['WMLS-C-095', 'WMLS-C-108'],
  '11.2',
  'explicit-must',
  'error-policy',
  'Require every taken jump target to fall on an instruction boundary within the current function.'
);
clause(
  'wmlscript',
  'runtime_function_validity',
  ['WMLS-C-096', 'WMLS-C-108'],
  '11.2',
  'explicit-must',
  'error-policy',
...
clause(
  'wmlscript',
  'runtime_constant_validity',
  ['WMLS-C-098', 'WMLS-C-108'],
  '11.2',
  'explicit-must',
  'error-policy',
  'Validate every constant index and required constant type before loading or using it.'
);
clause(
  'wmlscript',
  'runtime_stack_validity',
  [
    'WMLS-C-095',
    'WMLS-C-096',
    'WMLS-C-097',
...
clause(
  'wmlscript',
  'fatal_bytecode_error_matrix',
  ['WMLS-C-107', 'WMLS-C-108', 'WMLS-C-110'],
  '12.3',
  'table',
  'error-policy',
...
clause(
  'wmlscript',
  'nonfatal_continue_with_result',
  ['WMLS-C-111'],
  '12.4',
  'explicit-must',
  'error-policy',
  'Represent each non-fatal error by its specified invalid or zero result and allow the program to continue.'
);
clause(
  'wmlscript',
  'nonfatal_computation_matrix',
  ['WMLS-C-099', 'WMLS-C-111'],
  '12.4',
  'table',
  'runtime',
...
clause(
  'wmlscript',
  'nonfatal_constant_matrix',
  ['WMLS-C-098', 'WMLS-C-111'],
  '12.4',
  'table',
  'runtime',
...
clause(
  'wmlscript',
  'nonfatal_conversion_matrix',
  ['WMLS-C-073', 'WMLS-C-077', 'WMLS-C-111'],
  '12.4',
  'table',
  'runtime',
...
function libraryParentId(ordinal) {
  return ordinal === 48 ? 'WMLSSL048' : `WMLSSL-${String(ordinal).padStart(3, '0')}`;
}

const selectedLibraryFunctionParents = Array.from({ length: 64 }, (_, index) => index + 31)
...
clause(
  ...
  ['WMLSSL-014', ...selectedLibraryFunctionParents],
  '6.1',
  'implicit-must',
  'runtime',
  'Accept Boolean, Integer, Float, String, and Invalid values wherever a standard-library signature names those WMLScript types.'
);
clause(
  'wmlscript-libraries',
  'number_parameter_union',
  ['WMLSSL-014', ...selectedLibraryFunctionParents],
  '6.1',
  'implicit-must',
  'runtime',
  'Interpret a Number parameter as accepting either an Integer or Float value.'
);
clause(
  'wmlscript-libraries',
  'any_parameter_union',
  ...
  'implicit-must',
  'runtime',
  'Interpret an Any parameter as accepting every supported WMLScript value type.'
);
clause(
  'wmlscript-libraries',
  'automatic_argument_conversion',
  ['WMLSSL-015', ...selectedLibraryFunctionParents],
  '6.2',
  'implicit-must',
  'runtime',
  'Apply WMLScript automatic data conversions when an argument does not already have the required parameter type.'
);
clause(
  'wmlscript-libraries',
  'operator_conversion_default',
  ['WMLSSL-015', ...selectedLibraryFunctionParents],
  '6.2',
  'implicit-must',
  'runtime',
  'Use WMLScript operator conversion rules unless an individual library function explicitly defines another conversion.'
);
clause(
  'wmlscript-libraries',
  'invalid_argument_result',
  ['WMLSSL-016', ...selectedLibraryFunctionParents],
  '6.3',
  'implicit-must',
  'error-policy',
  'Return invalid without other side effects when a function receives an invalid argument, except where its definition explicitly specifies another outcome.'
);
clause(
  'wmlscript-libraries',
  'unconvertible_argument_result',
  ['WMLSSL-015', 'WMLSSL-016', ...selectedLibraryFunctionParents],
  '6.3',
  'implicit-must',
  'error-policy',
  'Return invalid without side effects when an argument cannot be converted to its required parameter type.'
);
clause(
  'wmlscript-libraries',
  'function_specific_error_result',
  ['WMLSSL-016', ...selectedLibraryFunctionParents],
  '6.3',
  'implicit-must',
  'error-policy',
  'Represent each function-specific exception using the return value or error code declared by that function definition.'
);
clause(
  'wmlscript-libraries',
  'integer_only_argument_types',
  ['WMLSSL-014', 'WMLSSL-015'],
  '6.4',
  'table',
  'runtime',
...
const standardLibraryDefinitions = [
  {
    ...
    libraryId: 0,
    functions:
      'abs=0, min=1, max=2, parseInt=3, parseFloat=4, isInt=5, isFloat=6, maxInt=7, minInt=8, float=9, exit=10, abort=11, random=12, seed=13, characterSet=14'
  },
  {
    key: 'float',
  ...
  },
  {
    ...
    libraryId: 2,
    functions:
      'length=0, isEmpty=1, charAt=2, subString=3, find=4, replace=5, elements=6, elementAt=7, removeAt=8, replaceAt=9, insertAt=10, squeeze=11, trim=12, compare=13, toString=14, format=15'
  },
  {
    key: 'url',
    ...
    libraryId: 3,
    functions:
      'isValid=0, getScheme=1, getHost=2, getPort=3, getPath=4, getParameters=5, getQuery=6, getFragment=7, getBase=8, getReferer=9, resolve=10, escapeString=11, unescapeString=12, loadString=13'
  },
  {
    key: 'wmlbrowser',
...
for (const library of standardLibraryDefinitions) {
  clause(
    'wmlscript-libraries',
    `${library.key}_library_surface`,
    [library.supportParent],
    library.section,
    'implicit-must',
    'runtime',
    `Expose the complete ${library.key} standard-library namespace and its selected functions through the WMLScript library-call boundary.`
  );
  clause(
    'wmlscript-libraries',
    `${library.key}_library_identifier`,
    [library.supportParent, 'WMLSSL-024'],
    'appendix-a',
    'table',
    'binary-decoder',
    `Map the ${library.key} standard library to encoded library identifier ${library.libraryId}.`
  );
  clause(
    'wmlscript-libraries',
    `${library.key}_function_identifiers`,
    [library.supportParent, library.identifierParent],
    'appendix-a',
    'table',
    'binary-decoder',
    `Map ${library.key} function identifiers exactly as follows: ${library.functions}.`
  );
}

function standardLibraryFunction({ key, parent, section, signature, behavior, details = [] }) {
  clause(
    'wmlscript-libraries',
    `${key}_signature`,
    [parent],
...
const langFunctions = [
  ...
  },
  {
    ...
    section: '7.2',
    signature:
      'Implement Lang.min(value1, value2) for two Number arguments, returning Number or invalid.',
    behavior:
      'Apply numeric conversion rules, return the smaller original value with its original type, and select the first argument when values compare equal.'
  },
  {
    key: 'lang_max',
    parent: 'WMLSSL-033',
  ...
  },
  {
    ...
    section: '7.5',
    signature:
      'Implement Lang.parseFloat(value) for a String argument, returning Float or invalid.',
    behavior:
    ...
    details: [
      {
        ...
        kind: 'error-policy',
        synopsis:
          'Return invalid for malformed floating-point syntax or when floating-point operations are unavailable.'
      }
    ]
  },
  {
    ...
    details: [
      {
        key: 'unsupported',
        kind: 'error-policy',
        synopsis: 'Return invalid when floating-point operations are unavailable.'
      }
    ]
  },
  {
    ...
    details: [
      {
        ...
        synopsis:
          'Use the literal string invalid as the error description when the supplied description value is invalid.'
      }
    ]
  },
  {
    ...
    details: [
      {
        key: 'float_bound',
        synopsis: 'Convert a Float bound through Float.int before selecting the random value.'
      },
      {
        key: 'bounds',
        kind: 'error-policy',
        synopsis: 'Return zero for a zero bound and invalid for a negative bound.'
      }
    ]
  },
  {
    ...
    section: '7.14',
    signature:
      'Implement Lang.seed(value) for a Number argument, returning empty String or invalid.',
    behavior:
      'Use a nonnegative integer seed to create a repeatable pseudo-random sequence and a negative seed to request system-dependent non-repeatable initialization.',
    details: [
      {
        key: 'float_seed',
        synopsis: 'Convert a Float seed through Float.int before initializing the sequence.'
      },
      {
        key: 'invalid_seed',
        kind: 'error-policy',
        synopsis: 'Return invalid and preserve the current seed when the argument is nonnumeric.'
      }
    ]
  },
  {
...
clause(
  'wmlscript-libraries',
  'float_library_integer_only_result',
  [
    'WMLSSL-046',
    'WMLSSL-047',
    'WMLSSL048',
    ...
    details: [
      {
        ...
        kind: 'error-policy',
        synopsis:
          'Return invalid for zero raised to a negative power or a negative base raised to a non-integer power.'
      }
    ]
  },
  {
...
const stringFunctions = [
  {
    ...
    behavior:
      'Return the number of characters in the converted string, with an empty string having length zero.'
  },
  {
    key: 'string_is_empty',
    parent: 'WMLSSL-056',
  ...
  },
  {
    ...
    behavior:
      'Convert a Float index through Float.int and return the one-character string at the resulting zero-based index.',
    details: [
      {
        key: 'out_of_range',
        synopsis: 'Return an empty string when the index is outside the string.'
      }
    ]
  },
  {
    ...
    section: '9.4',
    signature:
      'Implement String.subString(string, startIndex, length) for String and Number arguments, returning String or invalid.',
    behavior:
    ...
    details: [
      {
        key: 'empty_needle',
        kind: 'error-policy',
        synopsis: 'Return invalid when the requested substring is empty.'
      }
    ]
  },
  {
    ...
    behavior:
      'Replace every exact representation-sensitive, case-sensitive occurrence of the old substring with the new substring.',
    details: [
      {
        key: 'empty_needle',
        kind: 'error-policy',
        synopsis: 'Return invalid when the old substring is empty.'
      }
    ]
  },
  {
    ...
    details: [
      {
        key: 'empty_separator',
        kind: 'error-policy',
        synopsis: 'Return invalid when the separator string is empty.'
      }
    ]
  },
  {
    ...
    behavior:
      'Use the separator first character, convert Float index through Float.int, and clamp indexes below or above range to the first or last element.',
    details: [
      {
        key: 'empty_inputs',
        kind: 'error-policy',
        synopsis: 'Return an empty string for empty input text and invalid for an empty separator.'
      }
    ]
  },
  {
    ...
    section: '9.9',
    signature:
      'Implement String.removeAt(string, index, separator) for String, Number, and String arguments, returning String or invalid.',
    behavior:
  ...
  },
  {
    ...
    section: '9.10',
    signature:
      'Implement String.replaceAt(string, element, index, separator) for String, String, Number, and String arguments, returning String or invalid.',
    behavior:
  ...
  },
  {
    ...
    behavior:
      'Replace each consecutive run of TAB, VT, FF, space, LF, or CR characters with one space without trimming the string ends.'
  },
  {
    key: 'string_trim',
    parent: 'WMLSSL-067',
  ...
  },
  {
    ...
    section: '9.16',
    signature:
      'Implement String.format(format, value) for String and Any arguments, returning String or invalid.',
    behavior:
      'Parse percent, optional nonnegative width, optional precision, and required d, f, or s type fields, plus doubled-percent literals.',
    details: [
      {
        key: 'specifier_selection',
        synopsis:
      ...
      },
      {
        key: 'float_precision',
        synopsis:
          'For f, round to the requested fractional digits, default to six, and omit the decimal point at zero precision.'
      },
      {
        key: 'string_precision',
        synopsis: 'For s, truncate to the maximum character count when precision is specified.'
      },
      {
        key: 'conversion',
        synopsis:
          'Convert the value to the selected type using WMLScript rules, with Float.int used for Float-to-d conversion.'
      },
      {
        key: 'errors',
        kind: 'error-policy',
...
const urlFunctions = [
    ...
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when scheme extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Return the host without resolving a relative reference, or empty string when no host is present.',
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when host extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Return the explicit port text without applying a scheme default, or empty string when no port is present.',
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when port extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Return the absolute or unresolved-relative path while omitting parameters attached to its path segments.',
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when path extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when parameter extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Return the query text or empty string when absent, without resolving relative references.',
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when query extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Return the fragment text or empty string when absent, without resolving relative references.',
    details: [
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when fragment extraction encounters invalid URL syntax.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    behavior:
      'Return the shortest URL relative to the compilation-unit base for the resource that invoked the unit, or empty string when absent.',
    details: [
      {
        key: 'local_call',
        synopsis: 'Do not change the referer when execution crosses a local function call.'
      }
    ]
  },
  {
    ...
    section: '10.11',
    signature:
      'Implement URL.resolve(baseUrl, embeddedUrl) for two String arguments, returning String or invalid.',
    behavior:
      'Resolve a relative embedded URL against the base using RFC 2396, treating an empty base path as one slash and returning an absolute embedded URL unchanged.',
    details: [
      {
        key: 'rfc_algorithm',
        section: '5.2',
        anchorFamily: 'rfc-2396',
        synopsis:
      ...
      },
      {
        key: 'syntax_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when resolution encounters invalid URL syntax.'
      }
    ]
  },
  {
    ...
    behavior:
      'Percent-encode control, space, reserved, unwise, delimiter, and non-US-ASCII native-byte characters using two hexadecimal digits without parsing as a URL.',
    details: [
      {
        key: 'native_codes',
        synopsis: 'Use native character-set codes when escaping non-US-ASCII characters.'
      },
      {
        key: 'range_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when a character code exceeds hexadecimal FF.'
      }
    ]
  },
  {
    ...
    details: [
      {
        key: 'ascii_error',
        kind: 'error-policy',
        synopsis: 'Return invalid when the input contains a non-US-ASCII character.'
      }
    ]
  },
  {
    ...
    details: [
      {
        ...
        synopsis:
          'Send an Accept header containing only the supplied content type and expect text content regardless of other user-agent capabilities.'
      },
      {
        key: 'content_type_grammar',
        kind: 'parser',
        synopsis:
      ...
      },
      {
        key: 'type_error',
        kind: 'error-policy',
        synopsis: 'Return invalid for an erroneous requested content type.'
      }
    ]
  }
];
...
const wmlBrowserFunctions = [
  {
    ...
    section: '11.1',
    signature:
      'Implement WMLBrowser.getVar(name) for a String argument, returning String or invalid.',
    behavior:
    ...
    details: [
      {
        key: 'name_error',
        kind: 'error-policy',
        synopsis: 'Validate the WML variable-name grammar and return invalid for an illegal name.'
      }
    ]
  },
  {
    ...
    section: '11.2',
    signature:
      'Implement WMLBrowser.setVar(name, value) for two String arguments, returning Boolean or invalid.',
    behavior:
  ...
  },
  {
    ...
    section: '11.3',
    signature:
      'Implement WMLBrowser.go(url) for a String argument, returning empty String or invalid.',
    behavior:
      'Queue WML GO-equivalent navigation until script control returns, using the current card as referrer and as base for a relative URL.',
    details: [
      {
        key: 'last_request_wins',
        synopsis: 'Let the final go or prev call replace every earlier pending navigation request.'
      },
      {
        key: 'empty_cancels',
        synopsis: 'Treat a final go with empty URL as canceling every pending go or prev request.'
      },
      {
        key: 'fatal_cancels',
        kind: 'error-policy',
  ...
  },
  {
    ...
    details: [
      {
        key: 'last_request_wins',
        synopsis: 'Let the final prev or go call replace every earlier pending navigation request.'
      },
      {
        key: 'fatal_cancels',
        kind: 'error-policy',
  ...
  },
  {
    ...
    behavior:
      'Return the shortest current-card URL relative to the compilation-unit base, using absolute form when the deck base differs.',
    details: [
      {
        key: 'missing_card',
        kind: 'error-policy',
        synopsis: 'Return invalid when there is no current WML card.'
      }
    ]
  },
  {
...
const dialogFunctions = [
  ...
  },
  {
    ...
    behavior:
      'Display two alternatives, wait for selection, and return true for ok or false for cancel.',
    details: [
      {
        key: 'default_labels',
        synopsis:
          'Use implementation-dependent default label text when either supplied alternative label is empty.'
      }
    ]
  },
  {
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Decode multi-byte fields and bit fields using the specified most-significant-first network ordering.'
);
clause(
  'wbxml',
  'multibyte_continuation',
  ['WBXML-C-001'],
  '5.1',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wbxml',
  'charset_internal_default',
  ['WBXML-C-001'],
  '5.2',
  'explicit-must',
  'binary-decoder',
  'Without external charset metadata, present strings using the encoding named by the WBXML charset field.'
);
clause(
  'wbxml',
  'charset_external_precedence',
  ['WBXML-C-001'],
  '5.2',
  'explicit-should',
  'transport-boundary',
...
clause(
  'wbxml',
  'charset_string_termination',
  ['WBXML-C-001'],
  '5.2',
  'explicit-must',
  'binary-decoder',
  'Detect string termination according to the selected character encoding rather than assuming a one-byte terminator.'
);
clause(
  'wbxml',
  'document_header_order',
  ['WBXML-C-001'],
  '5.3',
  'grammar',
  'binary-decoder',
  'Decode each document in version, public identifier, charset, string-table, then body order.'
);
clause(
  'wbxml',
  'document_body_grammar',
  ['WBXML-C-001'],
  '5.3',
  'grammar',
  'binary-decoder',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Decode the initial version byte as major-minus-one in the high nibble and minor version in the low nibble.'
);
clause(
  'wbxml',
  'public_id_numeric',
  ...
  'implicit-must',
  'binary-decoder',
  'Accept a positive multi-byte numeric public identifier for a known document type.'
);
clause(
  'wbxml',
  'public_id_string_table',
  ['WBXML-C-001'],
  '5.5',
  'implicit-must',
  'binary-decoder',
  'When public identifier is zero, resolve its following index through the string table.'
);
clause(
  'wbxml',
  'charset_mibenum',
...
clause(
  'wbxml',
  'string_table_required',
  ['WBXML-C-001'],
  '5.7',
  'explicit-must',
  'binary-decoder',
  'Read a string-table length immediately after charset even when the table is empty.'
);
clause(
  'wbxml',
  'string_table_length',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Resolve string-table references as byte offsets from the first table byte.'
);
clause(
  'wbxml',
  'token_global_application_spaces',
  ['WBXML-C-001'],
  '5.8',
  'implicit-must',
  'binary-decoder',
...
clause(
  'wbxml',
  'token_tag_attribute_spaces',
  ['WBXML-C-001'],
  '5.8',
  'implicit-must',
  'binary-decoder',
  'Interpret application token values in separate tag and attribute code spaces.'
);
clause(
  'wbxml',
  'token_code_pages',
  ...
  'implicit-must',
  'binary-decoder',
  'Support 256 code pages per code space and reserve page 255 for implementation-specific use.'
);
clause(
  'wbxml',
  'parser_state_pages',
  ...
  'implicit-must',
  'binary-decoder',
  'Maintain separate current code pages for tag and attribute parser states, each initialized to page zero.'
);
clause(
  'wbxml',
  'parser_switch_persistence',
  ['WBXML-C-001'],
  '5.8.1',
  'implicit-must',
  'binary-decoder',
  'Keep a selected code page active for its parser state until another switch in that state or document end.'
);
clause(
  'wbxml',
  'tag_attribute_bit',
  ...
  'table',
  'binary-decoder',
  'Use tag bit seven to determine whether an END-terminated attribute list follows.'
);
clause(
  'wbxml',
  'tag_content_bit',
...
clause(
  ...
  'explicit-must',
  'binary-decoder',
  'Start every encoded attribute with one attribute-start token and terminate its value at the next start, literal, or END token.'
);
clause(
  'wbxml',
  'attribute_literal_value_prohibition',
  ['WBXML-C-001'],
  '5.8.3',
  'explicit-must',
  'binary-decoder',
...
clause(
  ...
  'grammar',
  'binary-decoder',
  'Decode STR_T as a multi-byte byte offset into the string table.'
);
clause(
  'wbxml',
  'empty_attribute_string',
  ['WBXML-C-001'],
  '5.8.4.1',
  'explicit-must',
  'binary-decoder',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Decode PI target and optional value using attribute-start/value syntax terminated by END.'
);
clause(
  'wbxml',
  'literal_name_state',
  ['WBXML-C-001', 'WBXML-C-011'],
  '5.8.4.5',
  'implicit-must',
  'binary-decoder',
...
clause(
  ...
  'implicit-must',
  'binary-decoder',
  'Decode OPAQUE as a multi-byte length followed by exactly that many application-specific bytes.'
);
clause(
  'wbxml',
  'end_token',
  ...
  'implicit-must',
  'binary-decoder',
  'Use END to terminate the current attribute list or element as determined by parser state.'
);
clause(
  'wbxml',
  'switch_page_token',
  ...
  'implicit-must',
  'binary-decoder',
  'Decode SWITCH_PAGE and its following page byte for the current parser state.'
);

clause(
  'wbxml',
  'default_attributes_omitted',
  ['WBXML-C-010'],
  '6.3',
  'explicit-may',
  'binary-decoder',
...
clause(
  'wbxml',
  'default_attributes_reconstructed',
  ['WBXML-C-010'],
  '6.3',
  'explicit-must',
  'binary-decoder',
...
clause(
  'wbxml',
  'external_token_typing',
  ['WBXML-C-011'],
  '6.4',
  'explicit-must',
  'transport-boundary',
  'Use an external typing system to associate an XML document family with its WBXML token values.'
);
clause(
  'wbxml',
  'mime_token_typing',
...
clause(
  'wbxml',
  'binary_literal_equivalence',
  ['WBXML-C-011'],
  '6.4',
  'explicit-must',
  'binary-decoder',
  'Decode both assigned binary tokens and literal encodings for every tag name, attribute name, and attribute value.'
);
...
const families = familyDefinitions.map((definition) => {
  ...
  const parentById = new Map(selectedParents.map((obligation) => [obligation.id, obligation]));
  const familyClauses = clauseRows.filter((candidate) => candidate.family === definition.family);
  ...
  for (const candidate of familyClauses) {
    ...
    const parents = candidate.parentRows.map((parentId) => parentById.get(parentId));
    candidate.mapping = {
      ownerLayers: [
        ...new Set(
          parents
            .flatMap((parent) => parent.mapping.ownerLayers)
            .concat(candidate.directWorkItems.includes('WSP-805') ? ['transport-rust'] : [])
        )
      ].sort(),
      workItems: [
        ...new Set([
  ...
  return {
    ...
    status: familyClauses.every((candidate) => candidate.fixturePlan.status === 'implemented')
      ? 'nested-clauses-fixture-backed'
      : familyClauses.some((candidate) => candidate.fixturePlan.status === 'implemented')
        ? 'nested-clauses-partially-fixture-backed'
        : 'nested-clauses-anchored-fixtures-planned',
    parentLedger: definition.ledgerPath,
    parentLedgerSha256: sha256(fs.readFileSync(definition.ledgerPath, 'utf8')),
    ...
    ...(definition.family === 'wbxml'
      ? {
          directEvidence: {
            corpusPath: 'transport-rust/tests/fixtures/transport/wbxml_wml13/conformance.json',
            testPath: 'transport-rust/src/tests/wbxml_conformance.rs',
            commands: [
...
const wmlFamily = families.find((family) => family.family === 'wml');
refreshWml306OptionalCapability(wmlFamily, readJson(wmlFamily.parentLedger));

const selectedParentCount = families.reduce(
  (total, family) => total + family.selectedParentCount,
  0
);
const clauseCount = families.reduce((total, family) => total + family.clauseCount, 0);
...
const ledger = {
  ...
  generatedFrom: {
    ...
    recordedOn,
    generator: 'spec-processing/scripts/generate-wap-selected-normative-clauses.mjs',
  ...
  summary: {
    ...
    assessedClauseCount: clauseRows.filter(
      (candidate) => candidate.mapping.clauseImplementationStatus === 'implemented'
    ).length
  },
  families
};
