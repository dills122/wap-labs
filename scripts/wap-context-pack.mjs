...
if (!target) {
  console.error(
    'Usage: node scripts/wap-context-pack.mjs TRN-7|TRN-702|TRN-703|TRN-706|TRN-707|TRN-708|TRN-710|WML-2|WML-201|WML-202|WML-203|WML-204|WML-205|WML-3|WML-301|WML-302|WML-303|WML-304|WML-305|WML-309|WSP-8|WSP-801|WSP-802|WSP-805|WMLS-5|WMLS-501'
  );
  process.exit(1);
}
