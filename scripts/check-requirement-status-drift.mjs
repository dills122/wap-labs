...
const familyDefinitions = [
  {
    ...
    expectedSelected: 39,
    expectedClauses: 175,
    expectedStatus: { implemented: 21, partial: 12, missing: 6 },
...
if (
  ...
  JSON.stringify({ done: 31, blocked: 1, 'in-progress': 10, todo: 41 })
) {
...
const requiredDocumentFragments = new Map([
  ...
  [
    ...
    [
      ...
      `| **Total** | **${aggregateSelected}** | **${aggregateClauses}** | **${aggregateStatus.implemented}** | **${aggregateStatus.partial}** | **${aggregateStatus.missing}** |`,
