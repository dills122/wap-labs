...
if (
  ...
  failures.push(
    'WMLS-502 context rendering must expose its 59 mapped operator/conversion clauses, 32 selected parents, and explicit closed mapping without a declared-family gap'
  );
}
