...
- Retrieve the narrowest supported context pack before acting:
  `node scripts/wap-context-pack.mjs <WML-2|WML-201..WML-205|WML-3|WML-301..WML-306|WML-309|TRN-7|TRN-702|TRN-703|TRN-706|TRN-707|TRN-708|TRN-710|WSP-8|WSP-801|WSP-802|WSP-805|WMLS-5|WMLS-501|WMLS-502>`.
