...
| WaveNav runtime (`engine-wasm/`) | Runtime covers deck/head/access/meta parsing, navigation, focus, input/select semantics, deterministic render output, native/WASM parity checks, the completed WML-201 76-row evidence projection, 14/14 mapped WML-202 clauses, and 23/23 mapped WML-204 clauses | Map and implement the WML-205 error taxonomy, then close the WML-202 access-policy/card-context gaps and residual WML-204 gates before advancing WML-3 runtime breadth |
