...
| WAP evidence program | 38/198 selected parent rows are implemented and 265/762 clauses are directly assessed; Atlas renders the canonical program and active documents | 63 partial and 97 missing parents remain, so the project stays explicitly pre-conformance |
