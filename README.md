...
| WAP evidence program | 23/201 selected parent rows are implemented and 149/780 clauses are directly assessed; Atlas renders the canonical program and active documents | 77 partial and 101 missing parents remain, so the project stays explicitly pre-conformance |
