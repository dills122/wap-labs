...
| WaveNav runtime (`engine-wasm/`) | Runtime covers deck/card parsing, navigation, focus, input/select semantics, deterministic render output, native/WASM parity checks, and 23/23 mapped WML-204 clause fixtures | Close the WML-201 mapping gap, WML-205 error taxonomy, and residual WML-202/WML-204 gates before advancing WML-3 runtime breadth |
