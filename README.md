...
|---|---|---|
| Waves desktop app (`browser/`) | Desktop shell is usable end-to-end with the closed `WBP-00` baseline and `WBP-01` shell gate, landed `WBP-02` reference handset, `WBP-03` toolbar IA, and `WBP-04` Welcome/Help tutorial path, plus reproducible window/keyboard evidence and real-WASM executable stories | Continue browser-owned `WBP-05` host accessibility without changing engine or transport contracts |
