...
| WAP evidence program | 24/198 selected parent rows are implemented and 208/762 clauses are directly assessed; Atlas renders the canonical program and active documents | 76 partial and 98 missing parents remain, so the project stays explicitly pre-conformance |
