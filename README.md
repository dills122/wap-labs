...
| WAP evidence program                             | 41/198 selected parent rows are implemented and 299/762 clauses are directly assessed; Atlas renders the canonical program and active documents                                                                                                                                                                                                                                                | 71 partial and 86 missing parents remain, so the project stays explicitly pre-conformance                                                              |
