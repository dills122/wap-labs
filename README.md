...
(updated 2026-07-28; audited at `1f07030a`).

| Track                                            | Implemented                                                                                                                                                                                                                                                                                                                                                                                    | Roadmap / In Progress                                                                                                                                  |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Waves desktop app (`browser/`)                   | Desktop shell is usable end-to-end; `WBP-00` through additive `WBP-05A` and `WBP-02A` are complete with native host chrome, accessibility evidence, and coordinated navigation/timer/input recovery                                                                                                                                                                                            | `WBP-06`/`F0-01` is ready for an explicitly owned contract task; sequence it around request-contract work and preserve the completed `D0-01` namespace |
| WaveNav runtime (`engine-wasm/`)                 | Runtime covers deck/head/access/meta parsing, navigation, focus, input/select semantics, deterministic render output, native/WASM parity checks, the completed WML-2 parser/validation baseline, completed WML-302 variable/substitution, WML-303 action/event/BACK, WML-305 timer, WML-309 frame/affordance contract, and additive WMLS-501 strict verifier evidence, plus WML-301's implemented context/history subset and WML-304's typed request-intent boundary | Apply WML-304 intents through native GET/POST serialization, close replayable POST history, and keep WMLS-502 execution plus fetch behavior in their owned follow-up lanes |
| Lowband transport (`transport-rust/`)            | The selected WDP/WCMP path and WBXML decoder have direct evidence; WSP-801 and WSP-802 close the selected connectionless PDU/header foundation, with bounded malformed-input and retransmission follow-up fixes landed                                                                                                                                                                         | Preserve strict connectionless evidence while advancing WSP-804/805 host ingress; activate WTP only with connection-oriented WSP                       |
