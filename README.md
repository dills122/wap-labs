...
| WAP evidence program                             | 40/198 selected parent rows are implemented and 288/762 clauses are directly assessed; Atlas renders the canonical program and active documents                                                                                                                                                                                                                                                | 71 partial and 87 missing parents remain, so the project stays explicitly pre-conformance                                                              |
