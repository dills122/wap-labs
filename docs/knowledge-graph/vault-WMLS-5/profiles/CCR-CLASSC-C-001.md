...
- `requires-family` → [[source-families/wmlscript-libraries|wmlscript-libraries]]
- `requires-family` → [[source-families/wmlscript|wmlscript]]
- `selected-from` → [[source-documents/WAP-215-ClassConform-20001213-a|WAP-215-ClassConform-20001213-a]]
- `targets-profile` ← [[sprints/WMLS-5|WMLS-5]]
