...
- `refines` ← [[clauses/WMLSCRIPT-CL-CHARACTER-SET-MIBENUM|WMLSCRIPT-CL-CHARACTER-SET-MIBENUM]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CHARACTER-SET-NATIVE-EXECUTION|WMLSCRIPT-CL-CHARACTER-SET-NATIVE-EXECUTION]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CHARACTER-STRING-BYTE-LENGTHS|WMLSCRIPT-CL-CHARACTER-STRING-BYTE-LENGTHS]]
...
```json
{
  ...
  "referencedSection": "Character encoding",
