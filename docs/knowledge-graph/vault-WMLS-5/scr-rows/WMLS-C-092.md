...
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-EMBEDDED-NULL|WMLSCRIPT-CL-CONSTANT-EMBEDDED-NULL]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-INTEGER-WIDTHS|WMLSCRIPT-CL-CONSTANT-INTEGER-WIDTHS]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-POOL-CHARSET|WMLSCRIPT-CL-CONSTANT-POOL-CHARSET]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-POOL-COUNT|WMLSCRIPT-CL-CONSTANT-POOL-COUNT]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-STRING-LENGTHS|WMLSCRIPT-CL-CONSTANT-STRING-LENGTHS]]
- `refines` ← [[clauses/WMLSCRIPT-CL-CONSTANT-TYPE-REGISTRY|WMLSCRIPT-CL-CONSTANT-TYPE-REGISTRY]]
...
```json
{
  ...
  "referencedSection": "Constant pool",
