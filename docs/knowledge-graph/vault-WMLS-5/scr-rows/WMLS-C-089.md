...
- `refines` ← [[clauses/WMLSCRIPT-CL-MULTIBYTE-INTEGER-CONTINUATION|WMLSCRIPT-CL-MULTIBYTE-INTEGER-CONTINUATION]]
- `refines` ← [[clauses/WMLSCRIPT-CL-MULTIBYTE-INTEGER-ORDER|WMLSCRIPT-CL-MULTIBYTE-INTEGER-ORDER]]
- `refines` ← [[clauses/WMLSCRIPT-CL-MULTIBYTE-INTEGER-UNUSED-ZERO|WMLSCRIPT-CL-MULTIBYTE-INTEGER-UNUSED-ZERO]]
...
```json
{
  ...
  "referencedSection": "Multi-byte integer format",
