...
- `refines` ← [[clauses/WMLSCRIPT-CL-FUNCTION-POOL-COUNT|WMLSCRIPT-CL-FUNCTION-POOL-COUNT]]
- `refines` ← [[clauses/WMLSCRIPT-CL-FUNCTION-POOL-INDEXES|WMLSCRIPT-CL-FUNCTION-POOL-INDEXES]]
...
```json
{
  ...
  "referencedSection": "Function pool",
