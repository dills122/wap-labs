...
- `refines` ← [[clauses/WMLSCRIPT-CL-OPERAND-TYPE-NO-CONVERSION|WMLSCRIPT-CL-OPERAND-TYPE-NO-CONVERSION]]
...
```json
{
  ...
  "referencedSection": "Access to operand type",
