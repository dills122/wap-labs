---
id: "clause:WMLSCRIPT-LIBRARIES-CL-INVALID-ARGUMENT-RESULT"
key: "WMLSCRIPT-LIBRARIES-CL-INVALID-ARGUMENT-RESULT"
type: "clause"
generated: true
slice: "WMLS-5"
tags:
...
- `refines` → [[scr-rows/WMLSSL-016|WMLSSL-016]]
- `refines` → [[scr-rows/WMLSSL-031|WMLSSL-031]]
- `refines` → [[scr-rows/WMLSSL-032|WMLSSL-032]]
...
- `refines` → [[scr-rows/WMLSSL-038|WMLSSL-038]]
- `refines` → [[scr-rows/WMLSSL-039|WMLSSL-039]]
...
- `refines` → [[scr-rows/WMLSSL-044|WMLSSL-044]]
...
- `refines` → [[scr-rows/WMLSSL-079|WMLSSL-079]]
...
- `verified-by` → [[fixtures/WMLSCRIPT-LIBRARIES-FX-INVALID-ARGUMENT-RESULT|WMLSCRIPT-LIBRARIES-FX-INVALID-ARGUMENT-RESULT]]
...
```json
{
  ...
  "sourceAnchor": {
    ...
    "section": "6.3",
    "heading": "6.3   Error Handling",
    "normalizedTextSha256": "b64f76d3c7b2d5002fce6bb43ecb47676c73d9584c4b29c4f716d08321e85209"
  },
  "normativeForce": "implicit-must",
  "obligationLevel": "required",
  "obligationSynopsis": "Return invalid without other side effects when a function receives an invalid argument, except where its definition explicitly specifies another outcome.",
  "workItems": [
    "W0-05",
    "W0-07",
    "W1-05",
