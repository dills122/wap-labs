---
id: "clause:WCMP-CL-GENERAL-ECHO-STRUCTURE"
key: "WCMP-CL-GENERAL-ECHO-STRUCTURE"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-ECHO-STRUCTURE|WCMP-FX-GENERAL-ECHO-STRUCTURE]]
...
```json
{
  ...
  "obligationSynopsis": "Encode Echo messages with Type, Code, Identifier, Sequence Number, and optional data.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
