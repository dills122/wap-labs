---
id: "clause:WCMP-CL-SINGLE-BEARER-FRAGMENT"
key: "WCMP-CL-SINGLE-BEARER-FRAGMENT"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
# Encode each WCMP message so it fits in one bearer-level fragment.
...
- `verified-by` → [[fixtures/WCMP-FX-SINGLE-BEARER-FRAGMENT|WCMP-FX-SINGLE-BEARER-FRAGMENT]]
...
```json
{
  ...
  "obligationSynopsis": "Encode each WCMP message so it fits in one bearer-level fragment.",
  "workItems": [
    "T0-17",
    "TRN-703"
  ],
