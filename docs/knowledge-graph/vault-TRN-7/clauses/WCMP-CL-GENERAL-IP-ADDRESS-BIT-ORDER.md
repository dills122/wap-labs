---
id: "clause:WCMP-CL-GENERAL-IP-ADDRESS-BIT-ORDER"
key: "WCMP-CL-GENERAL-IP-ADDRESS-BIT-ORDER"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-IP-ADDRESS-BIT-ORDER|WCMP-FX-GENERAL-IP-ADDRESS-BIT-ORDER]]
...
```json
{
  ...
  "obligationSynopsis": "Encode an IP address within WCMP address data with the most significant bit first.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
