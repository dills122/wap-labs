---
id: "clause:WCMP-CL-GENERAL-DESTINATION-UNREACHABLE-GENERATION"
key: "WCMP-CL-GENERAL-DESTINATION-UNREACHABLE-GENERATION"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-DESTINATION-UNREACHABLE-GENERATION|WCMP-FX-GENERAL-DESTINATION-UNREACHABLE-GENERATION]]
...
```json
{
  ...
  "obligationSynopsis": "Generate Destination Unreachable when a datagram cannot be delivered unless the failure is congestion.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
