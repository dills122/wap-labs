---
id: "clause:WCMP-CL-GENERAL-TYPE-DISPATCH"
key: "WCMP-CL-GENERAL-TYPE-DISPATCH"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
# Use Type to select the message data format and Code to select the subtype-specific interpretation.
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-TYPE-DISPATCH|WCMP-FX-GENERAL-TYPE-DISPATCH]]
...
```json
{
  ...
  "obligationSynopsis": "Use Type to select the message data format and Code to select the subtype-specific interpretation.",
  "workItems": [
    "T0-17",
    "TRN-703"
  ],
