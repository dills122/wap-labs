---
id: "clause:WCMP-CL-GENERAL-SINGLE-BEARER-FRAGMENT"
key: "WCMP-CL-GENERAL-SINGLE-BEARER-FRAGMENT"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-SINGLE-BEARER-FRAGMENT|WCMP-FX-GENERAL-SINGLE-BEARER-FRAGMENT]]
...
```json
{
  ...
  "obligationSynopsis": "Require each WCMP message to fit within one bearer-level fragment.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
