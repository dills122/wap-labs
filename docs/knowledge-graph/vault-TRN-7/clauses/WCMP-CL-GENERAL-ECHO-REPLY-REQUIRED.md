---
id: "clause:WCMP-CL-GENERAL-ECHO-REPLY-REQUIRED"
key: "WCMP-CL-GENERAL-ECHO-REPLY-REQUIRED"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-ECHO-REPLY-REQUIRED|WCMP-FX-GENERAL-ECHO-REPLY-REQUIRED]]
...
```json
{
  ...
  "obligationSynopsis": "Send an Echo Reply after receiving an Echo Request when the explicit non-IP capability permits replies.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
