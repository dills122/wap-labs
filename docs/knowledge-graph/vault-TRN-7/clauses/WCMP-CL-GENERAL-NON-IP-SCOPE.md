---
id: "clause:WCMP-CL-GENERAL-NON-IP-SCOPE"
key: "WCMP-CL-GENERAL-NON-IP-SCOPE"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-NON-IP-SCOPE|WCMP-FX-GENERAL-NON-IP-SCOPE]]
...
```json
{
  ...
  "obligationSynopsis": "Use the general WCMP protocol only for an explicitly selected non-IP bearer capability.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
