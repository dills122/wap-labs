---
id: "clause:WCMP-CL-GENERAL-ECHO-DATA-ROUNDTRIP"
key: "WCMP-CL-GENERAL-ECHO-DATA-ROUNDTRIP"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-ECHO-DATA-ROUNDTRIP|WCMP-FX-GENERAL-ECHO-DATA-ROUNDTRIP]]
...
```json
{
  ...
  "obligationSynopsis": "Return the Echo Request data unchanged in the corresponding Echo Reply when the return path can carry it.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
