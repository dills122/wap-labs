---
id: "clause:WCMP-CL-GENERAL-ECHO-PATH-MTU-TRUNCATION"
key: "WCMP-CL-GENERAL-ECHO-PATH-MTU-TRUNCATION"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-GENERAL-ECHO-PATH-MTU-TRUNCATION|WCMP-FX-GENERAL-ECHO-PATH-MTU-TRUNCATION]]
...
```json
{
  ...
  "obligationSynopsis": "Truncate only Echo Reply data when the return-path bearer fragment size cannot carry the complete request data.",
  "workItems": [
    "T0-17",
    "TRN-703",
    "TRN-710"
