---
id: "clause:WCMP-CL-ICMPV4-ERROR-QUOTE"
key: "WCMP-CL-ICMPV4-ERROR-QUOTE"
type: "clause"
generated: true
slice: "TRN-7"
tags:
...
- `verified-by` → [[fixtures/WCMP-FX-ICMPV4-ERROR-QUOTE|WCMP-FX-ICMPV4-ERROR-QUOTE]]
...
```json
{
  ...
  "obligationSynopsis": "Preserve the quoted original IPv4 header and first 64 data bits so the ICMPv4 error can be correlated with the affected WDP UDP datagram.",
  "workItems": [
    "TRN-708"
  ],
  "ownerLayers": [
