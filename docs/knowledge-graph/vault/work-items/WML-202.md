...
```json
{
  ...
  "notes": [
    ...
    "WML-203 now closes mandatory prologue and selected DTD content-model enforcement; WML-C-21 remains parent-partial for the broader sendreferer clause, and WML-205 retains the broader task-failure taxonomy; none is a residual WML-202 acceptance gate."
  ],
  "existingTickets": [
    "R0-04",
    "R0-12",
