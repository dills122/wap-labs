...
```json
{
  ...
  "notes": [
    ...
    "WML-203 closes mandatory prologue and selected DTD content-model enforcement; WML-C-21 remains parent-partial for the broader sendreferer clause, and WML-205 closes its separate error-enforcement and task-failure atomicity slice; none is a residual WML-202 acceptance gate."
  ],
  "existingTickets": [
    "R0-04",
    "R0-12",
