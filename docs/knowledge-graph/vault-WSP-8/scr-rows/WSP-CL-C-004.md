...
- `refines` ← [[clauses/WSP-CL-GET-PDU-LAYOUT|WSP-CL-GET-PDU-LAYOUT]]
- `refines` ← [[clauses/WSP-CL-GET-PDU-METHOD|WSP-CL-GET-PDU-METHOD]]
- `refines` ← [[clauses/WSP-CL-GET-URI-NO-NUL|WSP-CL-GET-URI-NO-NUL]]
