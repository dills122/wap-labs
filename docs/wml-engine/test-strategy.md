...
Current implemented fixture set lives under `engine-wasm/engine/tests/fixtures/phase-a/` and is validated by snapshot/state regression tests under `engine-wasm/engine/src/engine_tests/`.
