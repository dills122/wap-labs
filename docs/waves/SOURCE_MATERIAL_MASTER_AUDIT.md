...
- one-to-one mandatory/optional obligation ledgers for the WAP 1.2.1 target
  ...
  and WSP complete at SCR/source-work-item level; WML/WAE/WBXML nested
  clauses planned; the other six clause families and direct test evidence
  pending)
...
- 53 selected WML/WAE/WBXML rows now expand into 261 deduplicated nested
  clauses with source anchors and planned direct fixtures;
- the remaining 148 selected rows plus direct conformance fixture execution
