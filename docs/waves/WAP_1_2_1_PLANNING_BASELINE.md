...
| Fixtures | All 762 clause fixtures have target locations; 298 clauses now have direct conformance assessment and 464 remain unassessed |
...
Parent-row status is not a substitute for direct clause evidence. With 298 of
...
1. close or correct the 71 partial and 87 missing parent rows;
2. implement and assess the remaining 464 direct clause fixtures;
