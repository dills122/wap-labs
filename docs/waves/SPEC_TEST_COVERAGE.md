...
| Exact WAP-202 WCMP ledger: 62 rows / 5 selected | `0 implemented / 0 partial / 5 missing`; `0/5` direct normative tests | `spec-processing/source-manifests/wap-1.2.1-wcmp-scr.json`; validate with `node scripts/check-wap-transport-conformance-ledgers.mjs` |
