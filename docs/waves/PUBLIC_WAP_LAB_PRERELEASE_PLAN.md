...
The first stage keeps Cloudflare DNS absent and limits both SSH and UDP 9200 to the owner's CIDR.
...
open. Its default must fail closed: no DNS records, no public UDP ingress, restricted SSH, and no
