...
- `spec-processing/source-material/WAP-235-PushOTA-20010425-a.pdf`
- `spec-processing/source-material/WAP-235_100-PushOTA-20011008-a.pdf`
- `spec-processing/source-material/WAP-235_101-PushOTA-20020612-a.pdf`
- `spec-processing/source-material/WAP-247-PAP-20010429-a.pdf`
- `spec-processing/source-material/WAP-247_100-PAP-20011010-a.pdf`
- `spec-processing/source-material/WAP-249-PPGService-20010713-a.pdf`
- `spec-processing/source-material/WAP-249_102-PPGService-20011009-a.pdf`
- `spec-processing/source-material/WAP-250-PushArchOverview-20010703-a.pdf`
- `spec-processing/source-material/WAP-251-PushMessage-20010322-a.pdf`

### Provisioning family

- `spec-processing/source-material/WAP-182-PROVARCH-20010314-a.pdf`
- `spec-processing/source-material/WAP-183-PROVCONT-20010724-a.pdf`
- `spec-processing/source-material/WAP-183_003-PROVCONT-20010912-a.pdf`
- `spec-processing/source-material/WAP-183_004-PROVCONT-20011025-a.pdf`
- `spec-processing/source-material/WAP-183_005_PROVCONT-20020411-a.pdf`
- `spec-processing/source-material/WAP-184-PROVBOOT-20010314-a.pdf`
- `spec-processing/source-material/WAP-184_001-PROVBOOT-20011010-a.pdf`
- `spec-processing/source-material/WAP-185-PROVUAB-20010314-a.pdf`
- `spec-processing/source-material/WAP-186-PROVSC-20010710-a.pdf`

### Messaging/sync family

- `spec-processing/source-material/WAP-167-ServiceInd-20010731-a.pdf`
- `spec-processing/source-material/WAP-167_103-ServiceInd-20010926-a.pdf`
- `spec-processing/source-material/WAP-168-ServiceLoad-20010731-a.pdf`
- `spec-processing/source-material/WAP-168_103-ServiceLoad-20010816-a.pdf`
- `spec-processing/source-material/WAP-175-CacheOp-20010731-a.pdf`
- `spec-processing/source-material/WAP-175_102-CacheOp-20010816-a.pdf`
- `spec-processing/source-material/WAP-205-MMSArchOverview-20010425-a.pdf`
- `spec-processing/source-material/WAP-206-MMSCTR-20020115-a.pdf`
- `spec-processing/source-material/WAP-209-MMSEncapsulation-20020105-a.pdf`
- `spec-processing/source-material/WAP-234-SYNC-20010530-a.pdf`

### WTAI/telephony family

- `spec-processing/source-material/WAP-266-WTA-20010908-a.pdf`
- `spec-processing/source-material/WAP-268-WTAI-20010908-a.pdf`
- `spec-processing/source-material/WAP-228-WTAIIS95-20010908-a.pdf`
- `spec-processing/source-material/WAP-255-WTAIGSM-20010908-a.pdf`
- `spec-processing/source-material/WAP-269-WTAIIS136-20010908-a.pdf`
- `spec-processing/source-material/WAP-270-WTAIPDC-20010908-a.pdf`

### Presentation/xhtmlmp family

- `spec-processing/source-material/WAP-239-WCSS-20011026-a.pdf`
- `spec-processing/source-material/WAP-239-101-WCSS-20020430-a.pdf`
- `spec-processing/source-material/WAP-244-WMLTR-20011106-a.pdf`
- `spec-processing/source-material/WAP-277-XHTMLMP-20011029-a.pdf`

### Misc family

- `spec-processing/source-material/WAP-120-WAPCachingMod-20010413-a.pdf`
- `spec-processing/source-material/WAP-204-WAPOverGSMUSSD-20010730-a.pdf`
- `spec-processing/source-material/WAP-204_103-WAPOverGSMUSSD-20010813-a.pdf`
- `spec-processing/source-material/WAP-213-WAPInterPic-20010406-a.pdf`
- `spec-processing/source-material/WAP-213_101-WAPInterPic-20011123-a.pdf`
- `spec-processing/source-material/WAP-213_102-WAPInterPic-20011128-a.pdf`
- `spec-processing/source-material/WAP-227-PSTOR-20011220-a.pdf`
- `spec-processing/source-material/WAP-231-EFI-20011217-a.pdf`
