...
only after that direct evidence is reviewed. The current ledger records 374
implemented clauses with reviewed direct evidence and keeps 388 clauses
...
count describes planning relationships and is not the 374-clause assessed
evidence count.
