...
- AC:
  ...
  - Evidence: [x] WML-302 explicitly closes `HISTORY-RESOLVES-VARIABLES` at the engine boundary before same-deck history insertion or external navigation handoff. WML-304 retains GET/POST request construction and postfield serialization; replayable POST history remains assigned to A2 after A1.
