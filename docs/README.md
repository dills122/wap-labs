...
- `waves/ARCHIVAL_WAP_SERVICE_INCORPORATION_PLAN.md`: safe extraction of archival research ideas into first-party public lab fixtures, service demonstrations, and separately gated archive follow-ups
