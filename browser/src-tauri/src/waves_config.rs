...
pub const FETCH_TRANSPORT_PROFILE_ENV: &str = "WAVES_FETCH_TRANSPORT_PROFILE";
pub const FETCH_TRANSPORT_PROFILE_AUTO: &str = "auto";
pub const FETCH_TRANSPORT_PROFILE_GATEWAY_BRIDGED: &str = "gateway-bridged";
pub const FETCH_TRANSPORT_PROFILE_WAP_NET_CORE: &str = "wap-net-core";
